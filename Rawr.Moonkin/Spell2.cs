...
namespace Rawr.Moonkin
{
    ...
    abstract class Spell2
    {
        ...
        protected float baseCastTime = Spell2.GlobalCooldown;
        ...
        public float CastTime
        {
            ...
            set
            {
                if (value < Spell2.GlobalCooldown)
                    baseCastTime = Spell2.GlobalCooldown;
                else
                    baseCastTime = value;
            }
        }
    ...
    class SpellRotation
    {
        ...
        private List<Spell2> spells = new List<Spell2>();
        public List<Spell2> Spells
        {
            get
            {
                return spells;
    ...
    static class MoonkinSolver
    {
        ...
        public static void Solve(Character character, ref CharacterCalculationsMoonkin calcs)
        {
            ...
            foreach (SpellRotation rotation in SpellRotations)
            {
                ...
                Spell2.GlobalCooldown /= 1 + effectiveSpellHaste * (1 / 1576.0f);
        ...
        private static void RecreateSpells(Character character, ref CharacterCalculationsMoonkin calcs)
        {
            ...
            {
                Name = "MF/SFx4",
                Spells = new List<Spell2>(new Spell2[]
                {
                    moonfire,
                    starfire
                })
