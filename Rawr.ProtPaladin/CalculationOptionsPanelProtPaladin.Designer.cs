namespace Rawr.ProtPaladin
{
	partial class CalculationOptionsPanelProtPaladin
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelTargetArmorDescription.Text = StatConversion.NPC_BOSS_ARMOR.ToString() + ": Tier 8 Bosses";
			// 
			...
			this.extendedToolTipLabel3.TabIndex = 14;
			...
			this.comboBoxTrinketOnUseHandling.TabIndex = 13;
