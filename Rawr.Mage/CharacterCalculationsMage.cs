...
namespace Rawr.Mage
{
    ...
    public sealed class CharacterCalculationsMage : CharacterCalculationsBase
    {
        ...
        internal Dictionary<string, string> GetCharacterDisplayCalculationValuesInternal(bool computeReconstruction)
        {
            ...
            List<CycleId> cycleList = new List<CycleId>() { CycleId.ABAM, CycleId.FBSc, CycleId.FBFBlast, CycleId.ABABar0C, CycleId.FBPyro, CycleId.FFBPyro, CycleId.FBScPyro, CycleId.FFBScPyro, CycleId.FBLBPyro, CycleId.FrBFB, CycleId.FrBIL, CycleId.FrBILFB, CycleId.FBScLBPyro, CycleId.ScLBPyro, CycleId.FFBLBPyro, CycleId.FFBScLBPyro, CycleId.ABABar1C, CycleId.ABSpam3C, CycleId.AB3ABar3C, CycleId.FrBFBIL, CycleId.AB2ABar2C, CycleId.ABSpam3MBAM, CycleId.ABSpam03C, CycleId.ABSpam03MBAM, CycleId.AB2ABar2MBAM, CycleId.ABABar0MBAM, CycleId.AB2ABar3C, CycleId.ABABar3C, CycleId.ABABar2C, CycleId.ABABar2MBAM, CycleId.ABABar1MBAM, CycleId.AB3ABar3MBAM, CycleId.AB3AM, CycleId.AB2AM, CycleId.AB3AM2MBAM, CycleId.AB3AMABar, CycleId.AB3AMABar2C, CycleId.ABSpam4MBAM, CycleId.ABSpam24MBAM, CycleId.ABSpam234MBAM, CycleId.AB4AM234MBAM, CycleId.AB3AM23MBAM };
