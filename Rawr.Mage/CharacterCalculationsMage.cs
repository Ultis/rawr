...
namespace Rawr.Mage
{
    ...
    public sealed class CharacterCalculationsMage : CharacterCalculationsBase
    {
        ...
        public Spell ConjureManaGem { get; set; }
        ...
        internal Dictionary<string, string> GetCharacterDisplayCalculationValuesInternal()
        {
            ...
            dictValues.Add("Hit Rate", String.Format("{0:F}%*{1} Hit Rating", 100 * BaseState.SpellHit, BaseStats.HitRating));
            ...
            List<SpellId> spellList = new List<SpellId>() { SpellId.Wand, SpellId.ArcaneMissiles, SpellId.ABMBAM, SpellId.ArcaneBarrage, SpellId.Scorch, SpellId.Fireball, SpellId.Pyroblast, SpellId.FrostboltFOF, SpellId.ArcaneBlastSpam, SpellId.ABAM, SpellId.FBSc, SpellId.FBFBlast, SpellId.FireBlast, SpellId.ArcaneExplosion, SpellId.FlamestrikeSpammed, SpellId.Blizzard, SpellId.BlastWave, SpellId.DragonsBreath, SpellId.ConeOfCold, SpellId.FrostfireBoltFOF, SpellId.ABABar, SpellId.FBABar, SpellId.FrBABar, SpellId.FFBABar, SpellId.ABarAM, SpellId.ABP, SpellId.LivingBomb, SpellId.FBPyro, SpellId.FFBPyro, SpellId.FBScPyro, SpellId.FFBScPyro, SpellId.FBLBPyro, SpellId.FrBFB, SpellId.FBScLBPyro, SpellId.AB2ABar, SpellId.FB2ABar, SpellId.FrB2ABar, SpellId.ScLBPyro, SpellId.ABABarSlow, SpellId.FBABarSlow, SpellId.FrBABarSlow, SpellId.FFBLBPyro, SpellId.FFBScLBPyro, SpellId.ABABarX, SpellId.ABABarY, SpellId.AB2ABarMBAM, SpellId.AB3ABar, SpellId.AB3ABarX, SpellId.AB3ABarY, SpellId.AB3MBAMABar, SpellId.ABAMABar, SpellId.AB2AMABar, SpellId.AB3AMABar, SpellId.AB32AMABar, SpellId.AB3ABarC };
            ...
            bs = BaseState.GetSpell(SpellId.ArcaneBlast33) as BaseSpell;
            dictValues.Add("Arcane Blast(3)", String.Format("{0:F} Dps*{1:F} Mps\r\n{2:F} Tps\r\n{3:F} sec\r\n{14:F} Mana\r\n{9:F} - {10:F} Hit\r\n{11:F} - {12:F} Crit{13}\r\n{4:F}x Amplify\r\n{5:F}% Crit Rate\r\n{6:F}% Hit Rate\r\n{7:F} Crit Multiplier", bs.DamagePerSecond, bs.CostPerSecond - bs.ManaRegenPerSecond, bs.ThreatPerSecond, bs.CastTime - BaseState.Latency, bs.SpellModifier, bs.CritRate * 100, bs.HitRate * 100, bs.CritBonus, (AB.DamagePerSecond - bs.DamagePerSecond) / (AB.CostPerSecond - AB.ManaRegenPerSecond - bs.CostPerSecond + bs.ManaRegenPerSecond), bs.MinHitDamage / bs.HitProcs, bs.MaxHitDamage / bs.HitProcs, bs.MinCritDamage / bs.HitProcs, bs.MaxCritDamage / bs.HitProcs, ((bs.DotDamage > 0) ? ("\n" + bs.DotDamage.ToString("F") + " Dot") : ""), bs.Cost));
