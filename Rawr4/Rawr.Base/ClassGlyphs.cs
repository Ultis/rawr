...
namespace Rawr
{
    ...
    {
        public GlyphDataAttribute(int index, int id, string name, GlyphType type, string description)
        {
            _index = index;
            _id = id;
            _name = name;
    ...
    public partial class WarriorTalents
    {
        ...
        [GlyphData(0, 63324, "Glyph of Bladestorm", GlyphType.Prime, @"Reduces the cooldown on Bladestorm by 15 sec.")]
        ...
        [GlyphData(1, 58367, "Glyph of Bloodthirst", GlyphType.Prime, @"Increases the damage of Bloodthirst by 10%.")]
        ...
        [GlyphData(2, 58388, "Glyph of Devastate", GlyphType.Prime, @"Increases the critical strike chance of Devastate by 5%.")]
        ...
        [GlyphData(3, 58368, "Glyph of Mortal Strike", GlyphType.Prime, @"Increases the damage of Mortal Strike by 10%.")]
        ...
        [GlyphData(4, 58386, "Glyph of Overpower", GlyphType.Prime, @"Increases the damage of Overpower by 10%.")]
        ...
        [GlyphData(5, 58370, "Glyph of Raging Blow", GlyphType.Prime, @"Increases the critical strike chance of Raging Blow by 5%.")]
        ...
        [GlyphData(6, 58364, "Glyph of Revenge", GlyphType.Prime, @"Increases the damage of Revenge by 10%.")]
        ...
        [GlyphData(7, 58375, "Glyph of Shield Slam", GlyphType.Prime, @"Increases the damage of Shield Slam by 10%.")]
        ...
        [GlyphData(8, 58385, "Glyph of Slam", GlyphType.Prime, @"Increases the critical strike chance of Slam by 5%.")]
        ...
        [GlyphData(9, 58366, "Glyph of Cleaving", GlyphType.Major, @"Increases the number of targets your Cleave hits by 1.")]
        ...
        [GlyphData(10, 89003, "Glyph of Colossus Smash", GlyphType.Major, @"Your Colossus Smash refreshes the duration of Sunder Armor stacks on a target.")]
        ...
        [GlyphData(11, 94374, "Glyph of Death Wish", GlyphType.Major, @"Death Wish no longer increases damage taken.")]
        ...
        [GlyphData(12, 58357, "Glyph of Heroic Throw", GlyphType.Major, @"Your Heroic Throw applies a stack of Sunder Armor.")]
        ...
        [GlyphData(13, 94372, "Glyph of Intercept", GlyphType.Major, @"Increases the duration of your Intercept stun by 1 sec.")]
        ...
        [GlyphData(14, 58377, "Glyph of Intervene", GlyphType.Major, @"Increases the number of attacks you intercept for your Intervene target by 1.")]
        ...
        [GlyphData(15, 58097, "Glyph of Long Charge", GlyphType.Major, @"Increases the range of your Charge ability by 5 yards.")]
        ...
        [GlyphData(16, 58372, "Glyph of Piercing Howl", GlyphType.Major, @"Increases the radius of Piercing Howl by 50%.")]
        ...
        [GlyphData(17, 58355, "Glyph of Rapid Charge", GlyphType.Major, @"Reduces the cooldown of your Charge ability by 7%.")]
        ...
        [GlyphData(18, 58356, "Glyph of Resonating Power", GlyphType.Major, @"Reduces the rage cost of your Thunder Clap ability by 5.")]
        ...
        [GlyphData(19, 63329, "Glyph of Shield Wall", GlyphType.Major, @"Shield wall now reduces damage taken by 20%, but increases its cooldown by 2 min.")]
        ...
        [GlyphData(20, 63325, "Glyph of Shockwave", GlyphType.Major, @"Reduces the cooldown on Shockwave by 3 sec.")]
        ...
        [GlyphData(21, 63328, "Glyph of Spell Reflection", GlyphType.Major, @"Reduces the cooldown on Spell Reflection by 1 sec.")]
        ...
        [GlyphData(22, 58387, "Glyph of Sunder Armor", GlyphType.Major, @"Your Sunder Armor ability effects a second nearby target.")]
        ...
        [GlyphData(23, 58384, "Glyph of Sweeping Strikes", GlyphType.Major, @"Reduces the rage cost of Sweeping Strikes ability by 100%.")]
        ...
        [GlyphData(24, 58098, "Glyph of Thunder Clap", GlyphType.Major, @"Increases the radius of your Thunder Clap ability by 2 yards.")]
        ...
        [GlyphData(25, 58382, "Glyph of Victory Rush", GlyphType.Major, @"Increases the total healing provided by your Victory Rush by 50%.")]
        ...
        [GlyphData(26, 58095, "Glyph of Battle", GlyphType.Minor, @"Increases the duration by 2 min and area of effect by 50% of your Battle Shout.")]
        ...
        [GlyphData(27, 58096, "Glyph of Berserker Rage", GlyphType.Minor, @"Berserker Rage generates 5 rage when used.")]
        ...
        [GlyphData(28, 58369, "Glyph of Bloody Healing", GlyphType.Minor, @"Increases the healing your receive from your Bloodthirst ability by 100%.")]
        ...
        [GlyphData(29, 68164, "Glyph of Command", GlyphType.Minor, @"Increases the duration by 2 min and the area of effect by 50% of your Commanding Shout.")]
        ...
        [GlyphData(30, 58099, "Glyph of Demoralizing Shout", GlyphType.Minor, @"Increases the duration by 15 sec and area of effect 50% of your Demoralizing Shout.")]
        ...
        [GlyphData(31, 58104, "Glyph of Enduring Victory", GlyphType.Minor, @"Increases the window of opportunity in which you can use Victory Rush by 5 sec.")]
        ...
        [GlyphData(32, 63326, "Glyph of Furious Sundering", GlyphType.Minor, @"Reduces the cost of Sunder Armor by 50%.")]
        ...
        [GlyphData(33, 63327, "Glyph of Intimidating Shout", GlyphType.Minor, @"Targets of your Intimidating Shout now tremble in place instead of fleeing in fear.")]
    ...
    public partial class RogueTalents
    {
        ...
        #region Prime
        [GlyphData(0, "Glyph of Adrenaline Rush", GlyphType.Prime, @"Increases the duration of Adrenaline Rush by 5 sec.")]
        public bool GlyphOfAdrenalineRush { get { return _glyphData[0]; } set { _glyphData[0] = value; } }
        [GlyphData(1, "Glyph of Backstab", GlyphType.Prime, @"Your Backstab critical strikes grant you 5 energy.")]
        public bool GlyphOfBackstab { get { return _glyphData[1]; } set { _glyphData[1] = value; } }
        [GlyphData(2, "Glyph of Eviscerate", GlyphType.Prime, @"Increases the critical strike chance of Eviscerate by 10%.")]
        public bool GlyphOfEviscerate { get { return _glyphData[2]; } set { _glyphData[2] = value; } }
        [GlyphData(3, "Glyph of Hemorrhage", GlyphType.Prime, @"Your Hemorrhage ability also causes the target to bleed, dealing 40% of the direct strike's damage over 24 sec.")]
        public bool GlyphOfHemorrhage { get { return _glyphData[3]; } set { _glyphData[3] = value; } }
        [GlyphData(4, "Glyph of Killing Spree", GlyphType.Prime, @"Increases the bonus to your damage while Killing Spree is active by an additional 10%.")]
        public bool GlyphOfKillingSpree { get { return _glyphData[4]; } set { _glyphData[4] = value; } }
        [GlyphData(5, "Glyph of Mutilate", GlyphType.Prime, @"Reduces the cost of Mutilate by 5 energy.")]
        public bool GlyphOfMutilate { get { return _glyphData[5]; } set { _glyphData[5] = value; } }
        [GlyphData(6, "Glyph of Revealing Strike", GlyphType.Prime, @"Increases Revealing Strike's bonus effectiveness to your finishing moves by an additional 10%.")]
        public bool GlyphOfRevealingStrike { get { return _glyphData[6]; } set { _glyphData[6] = value; } }
        [GlyphData(7, "Glyph of Rupture", GlyphType.Prime, @"Increases the duration of Rupture by 4 sec.")]
        public bool GlyphOfRupture { get { return _glyphData[7]; } set { _glyphData[7] = value; } }
        [GlyphData(8, "Glyph of Shadow Dance", GlyphType.Prime, @"Increases the duration of Shadow Dance by 2 sec.")]
        public bool GlyphOfShadowDance { get { return _glyphData[8]; } set { _glyphData[8] = value; } }
        [GlyphData(9, "Glyph of Sinister Strike", GlyphType.Prime, @"Your Sinister Strikes have a 20% chance to add an additional combo point.")]
        public bool GlyphOfSinisterStrike { get { return _glyphData[9]; } set { _glyphData[9] = value; } }
        [GlyphData(10, "Glyph of Slice and Dice", GlyphType.Prime, @"Increases the duration of Slice and Dice by 3 sec.")]
        public bool GlyphOfSliceandDice { get { return _glyphData[10]; } set { _glyphData[10] = value; } }
        [GlyphData(11, "Glyph of Vendetta", GlyphType.Prime, @"Increases the duration of your Vendetta ability by 20%.")]
        public bool GlyphOfVendetta { get { return _glyphData[11]; } set { _glyphData[11] = value; } }
        #endregion
        #region Major
        [GlyphData(12, "Glyph of Ambush", GlyphType.Major, @"Increases the range on Ambush by 5 yards.")]
        public bool GlyphOfAmbush { get { return _glyphData[12]; } set { _glyphData[12] = value; } }
        [GlyphData(13, "Glyph of Blade Flurry", GlyphType.Major, @"Reduces the penalty to energy generation while Blade Flurry is active by 50%.")]
        public bool GlyphOfBladeFlurry { get { return _glyphData[13]; } set { _glyphData[13] = value; } }
        [GlyphData(13, "Glyph of Blind", GlyphType.Major, @"Your Blind ability also removes all damage over time effects from the target.")]
        public bool GlyphOfBlind { get { return _glyphData[13]; } set { _glyphData[13] = value; } }
        [GlyphData(14, "Glyph of Cloak of Shadows", GlyphType.Major, @"While Cloak of Shadows is active, you take 40% less physical damage.")]
        public bool GlyphOfCloakOfShadows { get { return _glyphData[14]; } set { _glyphData[14] = value; } }
        [GlyphData(15, "Glyph of Crippling Poison", GlyphType.Major, @"Increases the chance to trigger Crippling Poison by 20%.")]
        public bool GlyphOfCripplingPoison { get { return _glyphData[15]; } set { _glyphData[15] = value; } }
        [GlyphData(16, "Glyph of Deadly Throw", GlyphType.Major, @"Increases the slowing effect on Deadly Throw by 20%.")]
        public bool GlyphOfDeadlyThrow { get { return _glyphData[16]; } set { _glyphData[16] = value; } }
        [GlyphData(17, "Glyph of Evasion", GlyphType.Major, @"Increases the duration of Evasion by 5 sec.")]
        public bool GlyphOfEvasion { get { return _glyphData[17]; } set { _glyphData[17] = value; } }
        [GlyphData(18, "Glyph of Expose Armor", GlyphType.Major, @"Increases the duration of Expose Armor by 12 sec.")]
        public bool GlyphOfExposeArmor { get { return _glyphData[18]; } set { _glyphData[18] = value; } }
        [GlyphData(19, "Glyph of Fan of Knives", GlyphType.Major, @"Increases the radius of your Fan of Knives ability by 50%.")]
        public bool GlyphOfFanOfKnives { get { return _glyphData[19]; } set { _glyphData[19] = value; } }
        [GlyphData(20, "Glyph of Feint", GlyphType.Major, @"Reduces the energy cost of Feint by 20.")]
        public bool GlyphOfFeint { get { return _glyphData[20]; } set { _glyphData[20] = value; } }
        [GlyphData(21, "Glyph of Garrote", GlyphType.Major, @"Increases the duration of your Garrote ability's silence effect by 2 sec.")]
        public bool GlyphOfGarrote { get { return _glyphData[21]; } set { _glyphData[21] = value; } }
        [GlyphData(22, "Glyph of Gouge", GlyphType.Major, @"Your Gouge ability no longer requires that the target be facing you.")]
        public bool GlyphOfGouge { get { return _glyphData[22]; } set { _glyphData[22] = value; } }
        [GlyphData(23, "Glyph of Kick", GlyphType.Major, @"Increases the cooldown of your Kick ability by 4 sec, but this cooldown is reduced by 6 sec when your Kick successfully interrupts a spell.")]
        public bool GlyphOfKick { get { return _glyphData[23]; } set { _glyphData[23] = value; } }
        [GlyphData(24, "Glyph of Preparation", GlyphType.Major, @"Your Preparation ability also instantly resets the cooldown of Kick, Dismantle, and Smoke Bomb.")]
        public bool GlyphOfPreparation { get { return _glyphData[24]; } set { _glyphData[24] = value; } }
        [GlyphData(25, "Glyph of Sap", GlyphType.Major, @"Increases the duration of Sap against non-player targets by 80 sec.")]
        public bool GlyphOfSap { get { return _glyphData[25]; } set { _glyphData[25] = value; } }
        [GlyphData(26, "Glyph of Sprint", GlyphType.Major, @"Increases the movement speed of your Sprint ability by an additional 30%.")]
        public bool GlyphOfSprint { get { return _glyphData[26]; } set { _glyphData[26] = value; } }
        [GlyphData(27, "Glyph of Tricks of the Trade", GlyphType.Major, @"Removes the energy cost of your Tricks of the Trade ability but reduces the recipient's damage bonus by 5%.")]
        public bool GlyphOfTricksOfTheTrade { get { return _glyphData[27]; } set { _glyphData[27] = value; } }
        [GlyphData(27, "Glyph of Vanish", GlyphType.Major, @"Increases the duration of your Vanish effect by 2 sec.")]
        public bool GlyphOfVanish { get { return _glyphData[27]; } set { _glyphData[27] = value; } }
        #endregion
        #region Minor
    ...
    public partial class HunterTalents
    {
        ...
        [GlyphData(0, "Glyph of Aimed Shot", GlyphType.Prime, @"When you critically hit with Aimed Shot, you instantly gain 5 Focus.")]
        ...
        [GlyphData(1, "Glyph of Arcane Shot", GlyphType.Prime, @"Your Arcane Shot deals 12% more damage.")]
        ...
        [GlyphData(2, "Glyph of Chimera Shot", GlyphType.Prime, @"Reduces the cooldown of Chimera Shot by 1 sec.")]
        ...
        [GlyphData(3, "Glyph of Explosive Shot", GlyphType.Prime, @"Increases the critical strike chance of Explosive Shot by 6%.")]
        ...
        [GlyphData(4, "Glyph of Kill Command", GlyphType.Prime, @"Reduces the Focus cost of your Kill Command by 3.")]
        ...
        [GlyphData(5, "Glyph of Kill Shot", GlyphType.Prime, @"If the damage from your Kill Shot fails to kill a target at or below 20% health, your Kill Shot's cooldown is instantly reset. This effect has a 6 sec cooldown.")]
        ...
        [GlyphData(6, "Glyph of Rapid Fire", GlyphType.Prime, @"Increases the haste from Rapid Fire by an additional 10%.")]
        ...
        [GlyphData(7, "Glyph of Serpent Sting", GlyphType.Prime, @"Increases the periodic critical strike chance of your Serpent Sting by 6%.")]
        ...
        [GlyphData(8, "Glyph of Steady Shot", GlyphType.Prime, @"Increases the damage dealt by Steady Shot by 10%.")]
        ...
        [GlyphData(9, "Glyph of Dazzled Prey", GlyphType.Prime, @"Your Steady Shot generates an additional 2 Focus on targets afflicted by a daze effect.")]
        ...
        [GlyphData(10, "Glyph of Bestial Wrath", GlyphType.Major, @"Decreases the cooldown of Bestial Wrath by 20 sec.")]
        ...
        [GlyphData(11, "Glyph of Concussive Shot", GlyphType.Major, @"Your Concussive Shot also limits the maximum run speed of your target.")]
        ...
        [GlyphData(12, "Glyph of Deterrence", GlyphType.Major, @"Decreases the cooldown of Deterrence by 10 sec.")]
        ...
        [GlyphData(13, "Glyph of Disengage", GlyphType.Major, @"Decreases the cooldown of Disengage by 5 sec.")]
        ...
        [GlyphData(14, "Glyph of Freezing Trap", GlyphType.Major, @"When your Freezing Trap breaks, the victim's movement speed is reduced by 70% for 4 sec.")]
        ...
        [GlyphData(15, "Glyph of Ice Trap", GlyphType.Major, @"Increases the radius of the effect from your Ice Trap by 2 yards.")]
        ...
        [GlyphData(16, "Glyph of Immolation Trap", GlyphType.Major, @"Decreases the duration of the effect from your Immolation Trap by 6 sec., but damage while active is increased by 100%.")]
        ...
        [GlyphData(17, "Glyph of Master's Call", GlyphType.Major, @"Increases the duration of your Master's Call by 4 sec.")]
        ...
        [GlyphData(18, "Glyph of Mending", GlyphType.Major, @"Increases the total amount of healing done by your Mend Pet ability by 60%.")]
        ...
        [GlyphData(19, "Glyph of Misdirection", GlyphType.Major, @"When you use Misdirection on your pet, the cooldown on your Misdirection is reset.")]
        ...
        [GlyphData(20, "Glyph of Raptor Strike", GlyphType.Major, @"Reduces damage taken by 20% for 5 sec after using Raptor Strike.")]
        ...
        [GlyphData(21, "Glyph of Scatter Shot", GlyphType.Major, @"Increases the range of Scatter Shot by 3 yards.")]
        ...
        [GlyphData(22, "Glyph of Silencing Shot", GlyphType.Major, @"When you successfully silence an enemy's spell cast with Silencing Shot, you instantly gain 10 focus.")]
        ...
        [GlyphData(23, "Glyph of the Beast", GlyphType.Major, @"Increases the attack power bonus of Aspect of the Beast for you and your pet by an additional 2%.")]
        ...
        [GlyphData(24, "Glyph of Snake Trap", GlyphType.Major, @"Snakes from your Snake Trap take 90% reduced damage from area of effect spells.")]
        ...
        [GlyphData(25, "Glyph of Trap Launcher", GlyphType.Major, @"Reduces the focus cost of Trap Launcher by 10.")]
        ...
        [GlyphData(27, "Glyph of Aspect of the Pack", GlyphType.Minor, @"Increases the range of your Aspect of the Pack ability by 15 yards.")]
        ...
        [GlyphData(28, "Glyph of Feign Death", GlyphType.Minor, @"Reduces the cooldown of your Feign Death spell by 5 sec.")]
        ...
        [GlyphData(29, "Glyph of Mend Pet", GlyphType.Minor, @"Your Mend Pet spell increases your pet's happiness slightly.")]
