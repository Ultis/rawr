...
/// <para>CataCheck: Implemented as HealthRestoreFromMaxHealth SE</para>
/// </summary>
...
/// <summary>
/// Piercing Howl, 10 Rage, Instant cast
/// <para>Causes all enemies within 10 yards to be Dazed, reducing movement speed by 50% for 6 sec.</para>
/// </summary>
...
/// <summary>
/// Raging Blow - Berserker Stance - Melee Range - 20 Rage
/// <para>6 sec cooldown - Instant cast - Requires Melee Weapon</para>
/// <para>A mighty blow that deals 100% weapon damage from both melee weapons. Can only be used while Enraged.</para>
/// </summary>
...
/// <para>Removes any Immobilization effects and refreshes the cooldown of your Intercept ability.</para>
/// </summary>
...
#region Prot
#region Tier 1
/// <summary>Increases the critical strike chance of your Heroic Strike by [5*Pts]%, and your Heroic Strike critical strikes have a 
/// [100/3*Pts]% chance to make you next Heroic Strike also a critical strike. This effect cannot occur more than once every 6 seconds.</summary>
[TalentData(index: 41, name: "Incite", maxPoints: 3, icon: "ability_warrior_incite", tree: 2, column: 1, row: 1, prerequisite: -1, description: new[] {
...
/// <summary>Increases your armor value from items by [10 / 3 * Pts]%.</summary>
[TalentData(index: 42, name: "Toughness", maxPoints: 3, icon: "spell_holy_devotion", tree: 2, column: 2, row: 1, prerequisite: -1, description: new[] {
...
/// <summary>When you Thunder Clap a target affected by your Rend, you have a [50 * Pts]% chance to affect every target with Rend.</summary>
[TalentData(index: 43, name: "Blood and Thunder", maxPoints: 2, icon: "spell_nature_callstorm", tree: 2, column: 3, row: 1, prerequisite: -1, description: new[] {
...
#endregion
#region Tier 2
/// <summary>You generate [5*Pts] extra rage when you block an attack. You generate [20*Pts] extra rage when you Spell Reflect a magic attack.</summary>
...
/// <summary>Reduces the cooldown of your Shield Block by [10 * Pts] sec, your Shield Wall by [60 * Pts] sec and your Spell Reflect by [1 * Pts] sec.</summary>
...
/// <summary>Improves your critical strike and critical block chance by [5 * Pts]% for 10 sec following a successful parry.</summary>
...
#endregion
#region Tier 3
/// <summary>Last Stand - 3 min cooldown - Instant<para>Temporarily grants you 30% of your maximum health for 20 sec.  After the effect expires, the health is lost.</para></summary>
[TalentData(index: 48, name: "Last Stand", maxPoints: 1, icon: "spell_holy_ashestoashes", tree: 2, column: 1, row: 3, prerequisite: -1, description: new[] {
...
/// <summary>
/// Concussion Blow - Melee Range - Requires Melee Weapon
/// <para>30 sec cooldown - Instant cast - 15 Rage</para>
/// <para>Stuns the opponent for 5 sec and deals [38/100*AP] damage (based on attack power).</para>
/// </summary>
[TalentData(index: 49, name: "Concussion Blow", maxPoints: 1, icon: "ability_thunderbolt", tree: 2, column: 2, row: 3, prerequisite: -1, description: new[] {
...
/// <summary>Reduces the chance you'll be critically hit by melee attacks by [3 * Pts]% while in Defensive Stance.  In addition, when you block, dodge or parry an attack you have a [10 * Pts]% chance to become Enraged, increasing physical damage done by [5 * Pts]% for 12 sec.</summary>
[TalentData(index: 50, name: "Bastion of Defense", maxPoints: 2, icon: "ability_defend", tree: 2, column: 3, row: 3, prerequisite: -1, description: new[] {
...
/// <summary>Your Charge, Intercept and Intervene abilities are now usable while in combat and in any stance.  In addition, your Intervene ability will remove all movement impairing effects.</summary>
[TalentData(index: 51, name: "Warbringer", maxPoints: 1, icon: "ability_warrior_warbringer", tree: 2, column: 4, row: 3, prerequisite: -1, description: new[] {
...
Causes your Concentration Aura to make all affected targets immune to Silence and Interrupt effects and improve the effect of all other auras by 100%.  Lasts 6 sec.",})]
        ...
        /// <summary>
        /// Grants hit rating equal to [50 * Pts]% of any Spirit gained from items or effects.
        /// </summary>
        [TalentData(index: 16, name: "Spiritual Focus", maxPoints: 2, icon: "ability_paladin_blessedmending",
         tree: 0, column: 4, row: 5, prerequisite: -1, description: new[] {
@"Grants hit rating equal to 50% of any Spirit gained from items or effects.",
@"Grants hit rating equal to 100% of any Spirit gained from items or effects.",})]
        public int SpiritualFocus { get { return _data[16]; } set { _data[16] = value; } }
        /// <summary>
...
@"You have a 100% chance to gain a charge of Holy Power whenever you take direct damage.  This effect cannot occur more than once every 2 seconds.",})]
        ...
        /// 30 sec cooldown - Instant cast
        /// Send a wave of healing energy before you, healing yourself and all friendly targets up to 30 yards away for 1.
        /// </summary>
...
Requires One-Handed Melee Weapon - Hammer the current target for 30% weapon damage, causing a wave of light that hits all targets within 8 yards for 30 Holy damage. Grants a charge of Holy Power.",})]
        ...
        /// <summary>
        /// Increases the damage by [30 * Pts]% of your Crusader Strike and Judgement and increases the critical strike chance by [15 * Pts]% of your Holy Wrath and Hammer of Wrath.
        /// </summary>
...
@"Increases the damage by 30% of your Crusader Strike and Judgement and increases the critical strike chance by 15% of your Holy Wrath and Hammer of Wrath.",
@"Increases the damage by 60% of your Crusader Strike and Judgement and increases the critical strike chance by 30% of your Holy Wrath and Hammer of Wrath.",})]
...
@"You have a 20% chance after blocking an attack for your next 4 weapon swings within 8 sec to generate an additional attack.",})]
        ...
        /// <summary>
        /// Shield of the Righteous - Melee Range - 1 
        /// Instant cast
...
@"When your Ice Trap or Snake Trap are triggered you entrap all afflicted targets, preventing them from moving for 4 sec.",})]
        ...
        /// <summary>
        /// Increases the critical strike chance of all of your attacks on targets affected by your Ice Trap and Freezing Trap by [3 * Pts]%.
        /// </summary>
        [TalentData(index: 44, name: "Point of No Escape", maxPoints: 2, icon: "ability_hunter_pointofnoescape",
         tree: 2, column: 4, row: 2, prerequisite: -1, description: new[] {
@"Increases the critical strike chance of all of your attacks on targets affected by your Ice Trap and Freezing Trap by 3%.",
@"Increases the critical strike chance of all of your attacks on targets affected by your Ice Trap and Freezing Trap by 6%.",})]
        public int PointOfNoEscape { get { return _data[44]; } set { _data[44] = value; } }
        /// <summary>
        /// You have a [5 * Pts]% chance when you Arcane Shot, Explosive Shot or Black Arrow you instantly regain 40% of the base focus cost of the shot.
        /// </summary>
        [TalentData(index: 45, name: "Thrill of the Hunt", maxPoints: 3, icon: "ability_hunter_thrillofthehunt",
         tree: 2, column: 1, row: 3, prerequisite: -1, description: new[] {
@"You have a 5% chance when you Arcane Shot, Explosive Shot or Black Arrow you instantly regain 40% of the base focus cost of the shot.",
@"You have a 10% chance when you Arcane Shot, Explosive Shot or Black Arrow you instantly regain 40% of the base focus cost of the shot.",
@"You have a 15% chance when you Arcane Shot, Explosive Shot or Black Arrow you instantly regain 40% of the base focus cost of the shot.",})]
...
If Wyvern Sting is dispelled, the dispeller is also afflicted by Wyvern Sting lasting 50% of the duration remaining.",})]
        ...
        /// <summary>
        /// Increases your total Agility by an additional 20%, and  increases the Ranged and Melee Attack Speed of all party and raid members by 20%.
        /// </summary>
...
@"Targets hit by your Multi-Shot are also afflicted by your Serpent Sting equal to 9 sec of its total duration.",})]
        ...
        /// 30 sec cooldown - Instant cast
        /// Requires Ranged Weapon - Fires a Black Arrow at the target, dealing [RAP*0.115+157*5] Shadow damage over 15 sec. Black Arrow shares a cooldown with other Fire Trap spells.
        /// </summary>
...
Dark Evangelism (Mind Flay) - Increases the damage done by your Periodic Shadow spells by 2%.",})]
        ...
        /// 
        /// Archangel (Evangelism) - Instantly restores 3% of your total mana and increases your healing done by 3% for each stack. Lasts for 18 sec. 15 sec cooldown.
        /// 
...
Infuses the target with power, increasing spell casting speed by 20% and reducing the mana cost of all spells by 20%.  Lasts 15 sec.",})]
        ...
        /// <summary>
        /// When you deal damage with Smite, you instantly heal a nearby low health friendly party or raid target within 8 yards from the enemy target equal to [40 * Pts]% of the damage dealt.
        /// </summary>
        [TalentData(index: 9, name: "Atonement", maxPoints: 3, icon: "ability_priest_atonement",
         tree: 0, column: 3, row: 3, prerequisite: -1, description: new[] {
@"When you deal damage with Smite, you instantly heal a nearby low health friendly party or raid target within 8 yards from the enemy target equal to 40% of the damage dealt.",
@"When you deal damage with Smite, you instantly heal a nearby low health friendly party or raid target within 8 yards from the enemy target equal to 80% of the damage dealt.",
@"When you deal damage with Smite, you instantly heal a nearby low health friendly party or raid target within 8 yards from the enemy target equal to 120% of the damage dealt.",})]
...
Instantly reduces a friendly target's threat by 5%, reduces all damage taken by 40% and increases resistance to Dispel mechanics by 65% for 8 sec.",})]
        ...
        /// <summary>
        /// Whenever you are victim of an attack equal to damage greater than 10% of your total health, you gain Focused Will reducing all damage taken by [6 / 2 * Pts]% lasting for 8 sec. Stacks up to 2 times.
        /// </summary>
...
@"Whenever you are victim of an attack equal to damage greater than 10% of your total health, you gain Focused Will reducing all damage taken by 6% lasting for 8 sec. Stacks up to 2 times.",})]
        public int FocusedWill { get { return _data[17]; } set { _data[17] = value; } }
        /// <summary>
        /// Your Flash Heal, Greater Heal, Heal and Penance spells bless the target with Grace, increasing all healing received from the Priest by [2 * Pts]%. This effect will stack up to 3 times. Effect lasts 15 sec. Grace can only be active on one target at a time.
        /// </summary>
...
@"Reduces the casting time of your Smite, Holy Fire, Heal and Greater Heal spells by 0.5 sec.",})]
        ...
        /// </summary>
        [TalentData(index: 23, name: "Desperate Prayer", maxPoints: 1, icon: "spell_holy_restoration",
         tree: 1, column: 2, row: 2, prerequisite: -1, description: new[] {
@"Desperate Prayer - 2 min cooldown - Instant cast
Requires Shadowform - Instantly heals the caster for 263 to 325.",})]
        public int DesperatePrayer { get { return _data[23]; } set { _data[23] = value; } }
        /// <summary>
        /// When you Smite three times in a row, your spell haste will be increased by [5 * Pts]% for 12 sec.
        /// </summary>
        [TalentData(index: 24, name: "Trinity", maxPoints: 2, icon: "spell_holy_blessedlife",
         tree: 1, column: 3, row: 2, prerequisite: -1, description: new[] {
@"When you Smite three times in a row, your spell haste will be increased by 5% for 12 sec.",
@"When you Smite three times in a row, your spell haste will be increased by 10% for 12 sec.",})]
        public int Trinity { get { return _data[24]; } set { _data[24] = value; } }
        /// <summary>
...
@"Increases the amount of mana regeneration from Spirit while in combat by an additional 20%.",})]
        ...
        /// </summary>
        [TalentData(index: 28, name: "Surge of Light", maxPoints: 2, icon: "spell_holy_surgeoflight",
         tree: 1, column: 3, row: 3, prerequisite: 24, description: new[] {
...
@"You have a 6% chance when you Smite or Heal to cause your next Flash Heal to be instant cast and cost no mana but incapable of a critical hit.",})]
        public int SurgeOfLight { get { return _data[28]; } set { _data[28] = value; } }
        /// <summary>
        /// Lightwell - 40 yd range - 30% of base mana
        /// 3 min cooldown - 0.5 sec cast
        /// Creates a Holy Lightwell.  Friendly players can click the Lightwell to restore [((1+(SP*.308))*3)*1.25] health over 6 sec.  Attacks done to you equal to 30% of your total health will cancel the effect. Lightwell lasts for 3 min or 10 charges.
        /// </summary>
...
Creates a Holy Lightwell.  Friendly players can click the Lightwell to restore [((1+(SP*.308))*3)*1.25] health over 6 sec.  Attacks done to you equal to 30% of your total health will cancel the effect. Lightwell lasts for 3 min or 10 charges.",})]
        ...
        /// </summary>
        [TalentData(index: 30, name: "Serendipity", maxPoints: 2, icon: "spell_holy_serendipity",
         tree: 1, column: 1, row: 4, prerequisite: -1, description: new[] {
...
@"When you heal with Binding Heal or Flash Heal, the cast time of your next Greater Heal or Prayer of Healing spell is reduced by 20% and mana cost reduced by 10%. Stacks up to 2 times. Lasts 20 sec.",})]
        public int Serendipity { get { return _data[30]; } set { _data[30] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 31, name: "Spirit of Redemption", maxPoints: 1, icon: "inv_enchant_essenceeternallarge",
         tree: 1, column: 3, row: 4, prerequisite: -1, description: new[] {
@"Spirit of Redemption - Upon death, the priest becomes the Spirit of Redemption for 15 sec.  The Spirit of Redemption cannot move, attack, be attacked or targeted by any spells or effects.  While in this form the priest can cast any healing spell free of cost.  When the effect ends, the priest dies.",})]
        public int SpiritOfRedemption { get { return _data[31]; } set { _data[31] = value; } }
        /// <summary>
...
Smite - Increases your total damage done by Shadow and Holy spells by 15%.",})]
        ...
        /// 
        /// Holy Word: Aspire (Renew) - Instantly heals the target for 1 and another 6 over 18 sec. 15 sec cooldown.
        /// 
...
@"Your Mind Flay has a 60% chance to refresh the duration of your Shadow Word: Pain on the target, and reduces the damage you take from your own Shadow Word: Death by 40%.",})]
        ...
        /// 1.5 sec cast
        /// Causes 450 Shadow damage over 15 sec to your target and causes up to 10 party or raid members to gain 1% of their maximum mana per 10 sec when you deal damage from Mind Blast.
        /// </summary>
...
Reduces all damage taken by 30% and causes your skills, totems, and offensive spells to consume no mana for 15 sec.  This spell is usable while stunned.",})]
        ...
        /// <summary>
        /// Increases your expertise by [4 * Pts] and increases all party and raid members' attack power by [5 * Pts]% while within 100 yards of the Shaman.
        /// </summary>
...
@"Reduces the mana cost of your totems by 30% and increases their duration by 40%.",})]
        ...
        /// </summary>
        [TalentData(index: 43, name: "Focused Insight", maxPoints: 3, icon: "temp",
         tree: 2, column: 3, row: 2, prerequisite: -1, description: new[] {
...
@"When you critically heal with a single-target direct heal, you summon an Ancestral spirit to aid you, instantly healing the lowest percentage health friendly party or raid target within 40 yards for 30% of the amount healed.",})]
        ...
        /// Tools: Water Totem - Summons a Mana Tide Totem with 10% of the caster's health at the feet of the caster for 12 sec.  Party members within 40 yards of the totem have their Spirit increased by 200%.
        /// </summary>
...
@"Gives you a 10% chance when hit by a melee or ranged attack to increase your movement speed by 50% and dispel all movement impairing effects.  This effect lasts 8 sec.",})]
        ...
        /// <summary>
        /// Gives your damaging spells a [5 * Pts]% chance to reset the cooldown on Fire Blast and to cause the next Fire Blast you cast to stun the target for 2 sec and spread any Fire damage over time effects to nearby enemy targets within 12 yards.
        /// </summary>
...
@"Reduces the global cooldown of your Mage Ward spell by 1 sec and your Mage Ward triggers the Blazing Speed effect when it dissipates from absorbing damage.",})]
        ...
        /// 2 min cooldown - Instant cast
        /// Instantly deals 0 critical strike Fire damage and combines your Fire damage over time effects on the target into a single effect, burning for the same total damage for 10 sec.
        /// </summary>
...
@"Reduces the casting time of your Flamestrike spell by 100% and gives you a 100% chance that your Blast Wave spell will also automatically Flamestrike the same location if two or more targets are affected by the Blast Wave.",})]
        ...
        /// 20 sec cooldown - Instant cast
        /// Targets in a cone in front of the caster take 370 to 430 Fire damage and are Disoriented for 5 sec.  Any direct damaging attack will revive targets.
        /// </summary>
...
@"Increases spell haste by 10% if 3 or more targets are taking Fire damage over time from your spells.",})]
        ...
        [TalentData(index: 40, name: "Critical Mass", maxPoints: 3, icon: "spell_nature_wispheal",
         tree: 1, column: 3, row: 6, prerequisite: -1, description: new[] {
@"Your Living Bomb and Flame Orb spells deal 5% more damage, and your Pyroblast and Scorch spells have a 33% chance to cause your Pyroblast and Scorch spells have a 33% chance to cause your target to be vulnerable to spell damage, increasing spell critical strike chance against that target by 5% and lasts 30 sec.",
@"Your Living Bomb and Flame Orb spells deal 10% more damage, and your Pyroblast and Scorch spells have a 66% chance to cause your Pyroblast and Scorch spells have a 66% chance to cause your target to be vulnerable to spell damage, increasing spell critical strike chance against that target by 5% and lasts 30 sec.",
...
@"Increases the damage done by your Corruption by 12%.",})]
        ...
        /// <summary>
        /// Your Curse of the Elements also effects all nearby enemy targets within [20 * Pts] yards of the cursed target. 
        /// 
        /// Also, your Curse of the Weakness reduces the targets energy, rage, focus or runic power generation by [5 * Pts]% while active.
        /// </summary>
        [TalentData(index: 3, name: "Jinx", maxPoints: 2, icon: "ability_warlock_jinx",
         tree: 0, column: 1, row: 2, prerequisite: -1, description: new[] {
@"Your Curse of the Elements also effects all nearby enemy targets within 20 yards of the cursed target. 

Also, your Curse of the Weakness reduces the targets energy, rage, focus or runic power generation by 5% while active.",
@"Your Curse of the Elements also effects all nearby enemy targets within 40 yards of the cursed target. 

Also, your Curse of the Weakness reduces the targets energy, rage, focus or runic power generation by 10% while active.",})]
...
Soul Fire - Increases damage done by 18% and increases critical strike chance by 15%.",})]
        ...
        /// Summons a falling meteor down upon the enemy target, dealing 1 Shadow damage and erupts an aura of magic within 4 yards, causing all targets within it to have an increased 10% chance to be critically hit by any of your demons for until cancelled.
        /// </summary>
...
The damage done by your Burning Ember effect cannot exceed [SP*1.0+0] total damage.",})]
        ...
        /// <summary>
        /// Your Shadowburn, Soul Fire and Chaos Bolt instantly restore [5 * Pts]% of your total health and mana when they deal damage and also grant Replenishment.
        /// 
        /// Replenishment - Grants up to 10 party or raid members mana regeneration equal to 1% of the maximum mana per 10 sec. Lasts for 15 sec.
        /// </summary>
        [TalentData(index: 47, name: "Soul Leech", maxPoints: 2, icon: "spell_shadow_soulleech_3",
         tree: 2, column: 2, row: 4, prerequisite: -1, description: new[] {
@"Your Shadowburn, Soul Fire and Chaos Bolt instantly restore 5% of your total health and mana when they deal damage and also grant Replenishment.

Replenishment - Grants up to 10 party or raid members mana regeneration equal to 1% of the maximum mana per 10 sec. Lasts for 15 sec.",
@"Your Shadowburn, Soul Fire and Chaos Bolt instantly restore 10% of your total health and mana when they deal damage and also grant Replenishment.
...
Shadowfury is unleashed, causing 343 to 407 Shadow damage and stunning all enemies within 8 yds for 3 sec.",})]
        ...
        /// <summary>
        /// After being hit with a spell while using Nether Ward, you gain Nether Protection, reducing all damage by that spell school by [15 * Pts]% for 12 sec. Nether Protection can only occur once per Nether Ward.
        /// </summary>
...
@"After being hit with a spell while using Nether Ward, you gain Nether Protection, reducing all damage by that spell school by 15% for 12 sec. Nether Protection can only occur once per Nether Ward.",
@"After being hit with a spell while using Nether Ward, you gain Nether Protection, reducing all damage by that spell school by 30% for 12 sec. Nether Protection can only occur once per Nether Ward.",})]
...
@"Restoration",};
        ...
        /// <summary>
        /// You gain [5 * Pts]% spell h[1 * Pts]ste after you cast Moonfire or Insect Swarm, lasting 15 sec. This effect has a 1 minute cooldown. When you gain Lunar or Solar Eclipse, the cooldown of Nature's Torment is instantly reset.
        /// </summary>
        [TalentData(index: 0, name: "Nature's Torment", maxPoints: 3, icon: "spell_nature_naturesblessing",
         tree: 0, column: 1, row: 1, prerequisite: -1, description: new[] {
@"You gain 5% spell haste after you cast Moonfire or Insect Swarm, lasting 15 sec. This effect has 1 minute cooldown. When you gain Lunar or Solar Eclipse, the cooldown of Nature's Torment is instantly reset.",
@"You gain 10% spell haste after you cast Moonfire or Insect Swarm, lasting 15 sec. This effect has a 1 minute cooldown. When you gain Lunar or Solar Eclipse, the cooldown of Nature's Torment is instantly reset.",
@"You gain 15% spell haste after you cast Moonfire or Insect Swarm, lasting 15 sec. This effect has a 1 minute cooldown. When you gain Lunar or Solar Eclipse, the cooldown of Nature's Torment is instantly reset.",})]
        public int NaturesTorment { get { return _data[0]; } set { _data[0] = value; } }
        /// <summary>
...
@"Increases your nature and arcane spell damage by 2% and increases your spell hit rating by an additional amount equal to 100% of your Spirit.",})]
        ...
        /// <summary>
        /// Your Entangling Roots and Nature's Grasp have a [50 * Pts]% chance to also root all enemies within 8 yards of the target.
        /// </summary>
        [TalentData(index: 6, name: "Overgrowth", maxPoints: 2, icon: "spell_nature_stranglevines",
         tree: 0, column: 4, row: 2, prerequisite: -1, description: new[] {
@"Your Entangling Roots and Nature's Grasp have a 50% chance to also root all enemies within 8 yards of the target.",
@"Your Entangling Roots and Nature's Grasp have a 100% chance to also root all enemies within 8 yards of the target.",})]
        public int Overgrowth { get { return _data[6]; } set { _data[6] = value; } }
        /// <summary>
        ...
        /// 
        /// When you reach a Solar or Lunar eclipse, you instantly are restored [6 * Pts]% of your total mana.
        /// </summary>
        [TalentData(index: 7, name: "Euphoria", maxPoints: 2, icon: "achievement_boss_valithradreamwalker",
         tree: 0, column: 1, row: 3, prerequisite: -1, description: new[] {
...
When you reach a Solar or Lunar eclipse, you instantly are restored 12% of your total mana.",})]
        public int Euphoria { get { return _data[7]; } set { _data[7] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 8, name: "Moonkin Form", maxPoints: 1, icon: "spell_nature_forceofnature",
         tree: 0, column: 2, row: 3, prerequisite: -1, description: new[] {
@"Shapeshift - Moonkin Form - 13% of base mana
Instant cast
Requires Tree of Life Form - Shapeshift into Moonkin Form. While in this form your Arcane and Nature spell damage is increased by 1%, the armor contribution from items is increased by 120%, and grants 5% spell haste to all nearby friendly and raid targets within 100 yards.  The Moonkin can not cast healing or resurrection spells while shapeshifted.
...
The act of shapeshifting frees the caster of Polymorph and Movement Impairing effects.",})]
        public int MoonkinForm { get { return _data[8]; } set { _data[8] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 9, name: "Typhoon", maxPoints: 1, icon: "ability_druid_typhoon",
         tree: 0, column: 3, row: 3, prerequisite: -1, description: new[] {
@"Typhoon - 30 yd range - 32% of base mana
20 sec cooldown - Instant cast
You summon a violent Typhoon that does 400 Nature damage when in contact with hostile targets, knocking them back and dazing them for 6 sec.",})]
        public int Typhoon { get { return _data[9]; } set { _data[9] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 10, name: "Shooting Stars", maxPoints: 2, icon: "ability_mage_arcanebarrage",
         tree: 0, column: 4, row: 3, prerequisite: -1, description: new[] {
...
@"You have a 4% chance when you deal damage with your Moonfire or Insect Swarm to instantly reset the cooldown of your Starsurge and reduce its cast time by 100%. Lasts 8 sec.",})]
        public int ShootingStars { get { return _data[10]; } set { _data[10] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 11, name: "Owlkin Frenzy", maxPoints: 3, icon: "ability_druid_owlkinfrenzy",
         tree: 0, column: 2, row: 4, prerequisite: 8, description: new[] {
...
@"Attacks done to you while in Moonkin form have a 15% chance to cause you to go into a Frenzy, increasing your damage by 10% and causing you to be immune to pushback while casting Balance spells. Lasts 10 sec.",})]
        public int OwlkinFrenzy { get { return _data[11]; } set { _data[11] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 12, name: "Gale Winds", maxPoints: 2, icon: "ability_druid_galewinds",
         tree: 0, column: 3, row: 4, prerequisite: 9, description: new[] {
...
@"Increases damage done by your Hurricane and Typhoon spells by 30%, and increases the range of your Cyclone spell by 4 yards.",})]
        public int GaleWinds { get { return _data[12]; } set { _data[12] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 13, name: "Solar Beam", maxPoints: 1, icon: "ability_vehicle_sonicshockwave",
         tree: 0, column: 4, row: 4, prerequisite: -1, description: new[] {
@"Solar Beam - 40 yd range - 18% of base mana
1 min cooldown - Instant cast
You summon a beam of solar light over the enemy target's location, interupting the enemy target and silencing all enemy targets under the beam within 10 yards while it is active. Solar Beam lasts for 10 sec.",})]
        public int SolarBeam { get { return _data[13]; } set { _data[13] = value; } }
        /// <summary>
        /// When you cast your Innervate on yourself, you regain an additional [10 * Pts]% of your total mana over its duration.
        /// </summary>
        [TalentData(index: 14, name: "Dreamstate", maxPoints: 2, icon: "ability_druid_dreamstate",
         tree: 0, column: 1, row: 5, prerequisite: 7, description: new[] {
@"When you cast your Innervate on yourself, you regain an additional 10% of your total mana over its duration.",
@"When you cast your Innervate on yourself, you regain an additional 30% of your total mana over its duration.",})]
        ...
        /// </summary>
        [TalentData(index: 15, name: "Force of Nature", maxPoints: 1, icon: "ability_druid_forceofnature",
         tree: 0, column: 2, row: 5, prerequisite: -1, description: new[] {
@"Force of Nature - 40 yd range - 12% of base mana
3 min cooldown - Instant cast
Summons 3 treants to attack enemy targets for 30 sec.",})]
        public int ForceOfNature { get { return _data[15]; } set { _data[15] = value; } }
        /// <summary>
        /// While in Solar Eclipse, your Moonfire spell will morph into Sunfire.
        /// </summary>
        [TalentData(index: 16, name: "Sunfire", maxPoints: 1, icon: "ability_mage_firestarter",
         tree: 0, column: 3, row: 5, prerequisite: -1, description: new[] {
@"While in Solar Eclipse, your Moonfire spell will morph into Sunfire.",})]
        public int Sunfire { get { return _data[16]; } set { _data[16] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 17, name: "Earth and Moon", maxPoints: 1, icon: "ability_druid_earthandsky",
         tree: 0, column: 4, row: 5, prerequisite: -1, description: new[] {
@"Your Wrath and Starfire spells apply the Earth and Moon effect, which increases spell damage taken by 8% for 12 sec.  Also increases your spell damage by 2%.",})]
        public int EarthAndMoon { get { return _data[17]; } set { _data[17] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 18, name: "Fungal Growth", maxPoints: 2, icon: "creature_sporemushroom",
         tree: 0, column: 2, row: 6, prerequisite: 15, description: new[] {
...
@"When your Treants die or your Wild Mushrooms are triggered, you spawn a Fungal Growth at its wake covering the area within 8 yards, slowing all enemy targets by 70%. Lasts 10 sec.",})]
        public int FungalGrowth { get { return _data[18]; } set { _data[18] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 19, name: "Lunar Shower", maxPoints: 3, icon: "achievement_worldevent_lunar",
         tree: 0, column: 3, row: 6, prerequisite: 16, description: new[] {
...
@"When you cast Moonfire, you gain Lunar Shower. Lunar Shower increases the direct damage done by your Moonfire by 45%, and reduces the mana cost by 30%. This effect is refreshed and amplified when you move, stacking up to 3 times. Effect lasts for 3 sec.",})]
        public int LunarShower { get { return _data[19]; } set { _data[19] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 20, name: "Starfall", maxPoints: 1, icon: "ability_druid_starfall",
         tree: 0, column: 2, row: 7, prerequisite: -1, description: new[] {
@"Starfall - 35% of base mana
1 min cooldown - Instant cast
You summon a flurry of stars from the sky on all targets within 40 yards of the caster, each dealing 111 to 129 Arcane damage. Maximum 20 stars. Lasts 10 sec.  
...
Shapeshifting into an animal form or mounting cancels the effect. Any effect which causes you to lose control of your character will suppress the starfall effect.",})]
        public int Starfall { get { return _data[20]; } set { _data[20] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 21, name: "Feral Swiftness", maxPoints: 2, icon: "spell_nature_spiritwolf",
         tree: 1, column: 1, row: 1, prerequisite: -1, description: new[] {
...
@"Increases your movement speed by 30% in Cat Form and increases your chance to dodge while in Cat Form or Bear Form by 4%.",})]
        public int FeralSwiftness { get { return _data[21]; } set { _data[21] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 22, name: "Furor", maxPoints: 3, icon: "spell_holy_blessingofstamina",
         tree: 1, column: 2, row: 1, prerequisite: -1, description: new[] {
...
@"Grants you a 100% chance to gain 10 Rage when you shapeshift into Bear Form, allows you to keep up to 100 of your Energy when you shapeshift into Cat Form, and increases your maximum mana by 15%.",})]
        public int Furor { get { return _data[22]; } set { _data[22] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 23, name: "Predatory Strikes", maxPoints: 2, icon: "ability_hunter_pet_cat",
         tree: 1, column: 3, row: 1, prerequisite: -1, description: new[] {
...
@"Increases the critical strike chance of your Ravage by 50% on targets at or above 90% health, and your finishing moves have a 20% chance per combo point to make your next Nature spell with a base casting time less than 10 sec. become an instant cast spell.",})]
        public int PredatoryStrikes { get { return _data[23]; } set { _data[23] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 24, name: "Infected Wounds", maxPoints: 2, icon: "ability_druid_infectedwound",
         tree: 1, column: 1, row: 2, prerequisite: -1, description: new[] {
...
@"Your Shred, Ravage, Maul, and Mangle attacks cause an Infected Wound in the target. The Infected Wound reduces the movement speed of the target by 50% and the attack speed by 20%. Lasts 12 sec.",})]
        public int InfectedWounds { get { return _data[24]; } set { _data[24] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 25, name: "Fury Swipes", maxPoints: 3, icon: "ability_druid_mangle.tga",
         tree: 1, column: 2, row: 2, prerequisite: -1, description: new[] {
...
@"When you auto-attack while in Cat form or Bear form, you have a 12% chance to gain an extra auto-attack on the same target. This effect cannot occur more than once every 6 sec.",})]
        public int FurySwipes { get { return _data[25]; } set { _data[25] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 26, name: "Primal Fury", maxPoints: 2, icon: "ability_racial_cannibalize",
         tree: 1, column: 3, row: 2, prerequisite: -1, description: new[] {
...
@"Gives you a 100% chance to gain an additional 5 Rage anytime you get a critical strike while in Bear Form and your critical strikes from Cat Form abilities that add combo points  have a 100% chance to add an additional combo point.",})]
        public int PrimalFury { get { return _data[26]; } set { _data[26] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 27, name: "Feral Aggression", maxPoints: 2, icon: "ability_druid_demoralizingroar",
         tree: 1, column: 4, row: 2, prerequisite: -1, description: new[] {
...
@"Increases the damage caused by your Ferocious Bite by 10% and causes Faerie Fire (Feral) to apply 3 stacks of the Faerie Fire effect when cast.",})]
        public int FeralAggression { get { return _data[27]; } set { _data[27] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 28, name: "King of the Jungle", maxPoints: 3, icon: "ability_druid_kingofthejungle",
         tree: 1, column: 1, row: 3, prerequisite: -1, description: new[] {
...
@"While using your Enrage ability in Bear Form, your damage is increased by 15%, and your Tiger's Fury ability also instantly restores 60 energy.",})]
        public int KingOfTheJungle { get { return _data[28]; } set { _data[28] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 29, name: "Feral Charge", maxPoints: 1, icon: "ability_hunter_pet_bear",
         tree: 1, column: 2, row: 3, prerequisite: -1, description: new[] {
@"Teaches Feral Charge (Bear) and Feral Charge (Cat).
...
Feral Charge (Cat) - Causes you to leap behind an enemy, dazing them for 3 sec. 30 second cooldown.",})]
        public int FeralCharge { get { return _data[29]; } set { _data[29] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 30, name: "Stampede", maxPoints: 2, icon: "spell_druid_feralchargecat",
         tree: 1, column: 3, row: 3, prerequisite: 29, description: new[] {
...
@"Increases your melee haste by 30% after you use Feral Charge (Bear) for 8 sec, and Ravage will temporarly not require stealth for 6 sec after you use Feral Charge (Cat).",})]
        public int Stampede { get { return _data[30]; } set { _data[30] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 31, name: "Thick Hide", maxPoints: 3, icon: "inv_misc_pelt_bear_03",
         tree: 1, column: 4, row: 3, prerequisite: -1, description: new[] {
...
@"Increases your Armor contribution from cloth and leather items by 10%, increases armor while in Bear Form by an additional 33%, and reduces the chance you'll be critically hit by melee attacks by 6%.",})]
        public int ThickHide { get { return _data[31]; } set { _data[31] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 32, name: "Leader of the Pack", maxPoints: 1, icon: "spell_nature_unyeildingstamina",
         tree: 1, column: 2, row: 4, prerequisite: -1, description: new[] {
@"While in Cat Form or Bear Form, the Leader of the Pack increases critical strike chance of all party and raid members within 100 yards by 5%.  In addition, your melee critical strikes in Cat Form and Bear Form cause you to heal for 8% of your total health and gain 8% of your maximum mana.  This effect cannot occur more than once every 6 sec.",})]
        public int LeaderOfThePack { get { return _data[32]; } set { _data[32] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 33, name: "Brutal Impact", maxPoints: 2, icon: "ability_druid_bash",
         tree: 1, column: 3, row: 4, prerequisite: -1, description: new[] {
...
@"Increases the stun duration of your Bash and Pounce abilities by 1 sec, decreases the cooldown of Bash by 10 sec, decreases the cooldown of Skull Bash by 50 sec, and causes victims of your Skull Bash ability to have 30% increased mana cost for their spells for 10 sec.",})]
        public int BrutalImpact { get { return _data[33]; } set { _data[33] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 34, name: "Nurturing Instinct", maxPoints: 2, icon: "ability_druid_healinginstincts",
         tree: 1, column: 4, row: 4, prerequisite: -1, description: new[] {
...
@"Increases your healing spells by up to 70% of your Agility, and increases healing done to you by 20% while in Cat form.",})]
        public int NurturingInstinct { get { return _data[34]; } set { _data[34] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 35, name: "Primal Madness", maxPoints: 2, icon: "ability_mount_jungletiger",
         tree: 1, column: 1, row: 5, prerequisite: 28, description: new[] {
...
@"Tiger's Fury and Berserk also increase your current and maximum energy by 20 during their durations, and your Enrage and Berserk abilities instantly generate 12 Rage.",})]
        public int PrimalMadness { get { return _data[35]; } set { _data[35] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 36, name: "Survival Instincts", maxPoints: 1, icon: "ability_druid_tigersroar",
         tree: 1, column: 2, row: 5, prerequisite: -1, description: new[] {
@"Cat or Bear Form - Survival Instincts - 5 min cooldown - Instant
Reduces all damage taken by 60% for 12 sec.  Only useable while in Bear Form or Cat Form.",})]
        public int SurvivalInstincts { get { return _data[36]; } set { _data[36] = value; } }
        /// <summary>
        /// Increases the duration of your Rake by [3 * Pts] sec and your Savage Roar and Pulverize by [3 * Pts] sec.
        /// </summary>
        [TalentData(index: 37, name: "Endless Carnage", maxPoints: 2, icon: "spell_deathknight_bloodboil",
         tree: 1, column: 3, row: 5, prerequisite: -1, description: new[] {
...
@"Increases the duration of your Rake by 6 sec and your Savage Roar and Pulverize by 6 sec.",})]
        public int EndlessCarnage { get { return _data[37]; } set { _data[37] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 38, name: "Natural Reaction", maxPoints: 2, icon: "ability_bullrush",
         tree: 1, column: 4, row: 5, prerequisite: -1, description: new[] {
...
@"Reduces damage taken while in Bear Form by 12%, increases your dodge while in Bear Form by 6%, and you generate 3 rage every time you dodge while in Bear Form.",})]
        public int NaturalReaction { get { return _data[38]; } set { _data[38] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 39, name: "Blood in the Water", maxPoints: 2, icon: "inv_misc_food_134_meat",
         tree: 1, column: 1, row: 6, prerequisite: -1, description: new[] {
...
@"When you Ferocious Bite a target at or below 25% health, you have a 100% chance to instantly refresh the duration of your Rip on the target.",})]
        public int BloodInTheWater { get { return _data[39]; } set { _data[39] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 40, name: "Rend and Tear", maxPoints: 3, icon: "ability_druid_primalagression",
         tree: 1, column: 2, row: 6, prerequisite: -1, description: new[] {
...
@"Increases damage done by your Maul and Shred attacks on bleeding targets by 20%, and increases the critical strike chance of your Ferocious Bite ability on bleeding targets by 25%.",})]
        public int RendAndTear { get { return _data[40]; } set { _data[40] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 41, name: "Pulverize", maxPoints: 1, icon: "ability_smash",
         tree: 1, column: 3, row: 6, prerequisite: 40, description: new[] {
@"Bear Form - Pulverize - Melee Range - 15 Rage
Instant cast
Deals 120% weapon damage plus additional 943.2 damage for each of your Lacerate applications on the target, and increases your melee critical strike chance by 2% for each Lacerate application consumed for 10 sec.",})]
        public int Pulverize { get { return _data[41]; } set { _data[41] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 42, name: "Berserk", maxPoints: 1, icon: "ability_druid_berserk",
         tree: 1, column: 2, row: 7, prerequisite: -1, description: new[] {
@"Cat or Bear Form - Berserk - 3 min cooldown - Instant cast
Your Lacerate periodic damage has a 30% chance to refresh the cooldown of your Mangle (Bear) ability and make it cost no rage.  In addition, when activated this ability causes your Mangle (Bear) ability to hit up to 3 targets and have no cooldown, and reduces the energy cost of all your Cat Form abilities by 50%.  Lasts 15 sec.  You cannot use Tiger's Fury while Berserk is active. 

Clears the effect of Fear and makes you immune to Fear for the duration.",})]
        public int Berserk { get { return _data[42]; } set { _data[42] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 43, name: "Blessing of the Grove", maxPoints: 2, icon: "spell_shaman_spiritlink",
         tree: 2, column: 1, row: 1, prerequisite: -1, description: new[] {
...
@"Increases the healing done by your Rejuvenation by 4%, the direct damage of your Moonfire by 6% and the damage done by your Claw and Shred by 4%.",})]
        public int BlessingOfTheGrove { get { return _data[43]; } set { _data[43] = value; } }
        /// <summary>
        /// Reduces the mana cost of all shapeshifting by [10 * Pts]%.
        /// </summary>
        [TalentData(index: 44, name: "Natural Shapeshifter", maxPoints: 2, icon: "spell_nature_wispsplode",
         tree: 2, column: 2, row: 1, prerequisite: -1, description: new[] {
@"Reduces the mana cost of all shapeshifting by 10%.",
@"Reduces the mana cost of all shapeshifting by 20%.",})]
        public int NaturalShapeshifter { get { return _data[44]; } set { _data[44] = value; } }
        /// <summary>
        /// Reduces the cast time of your Healing Touch and Nourish spells by [0.2 * Pts] sec.
        /// </summary>
        [TalentData(index: 45, name: "Naturalist", maxPoints: 2, icon: "spell_nature_healingtouch",
         tree: 2, column: 3, row: 1, prerequisite: -1, description: new[] {
...
@"Reduces the cast time of your Healing Touch and Nourish spells by 0.5 sec.",})]
        public int Naturalist { get { return _data[45]; } set { _data[45] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 46, name: "Heart of the Wild", maxPoints: 3, icon: "spell_holy_blessingofagility",
...
@"Increases your Intellect by 6%.  In addition, while in Bear Form your Stamina is increased by 10% and while in Cat Form your attack power is increased by 10%.",})]
        public int HeartOfTheWild { get { return _data[46]; } set { _data[46] = value; } }
        /// <summary>
        /// Reduces all spell damage taken by [2 * Pts]%.
        /// </summary>
        [TalentData(index: 47, name: "Perseverance", maxPoints: 3, icon: "achievement_zone_darnassus",
         tree: 2, column: 1, row: 2, prerequisite: -1, description: new[] {
@"Reduces all spell damage taken by 2%.",
@"Reduces all spell damage taken by 4%.",
@"Reduces all spell damage taken by 6%.",})]
        public int Perseverance { get { return _data[47]; } set { _data[47] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 48, name: "Master Shapeshifter", maxPoints: 1, icon: "ability_druid_mastershapeshifter",
         tree: 2, column: 2, row: 2, prerequisite: 44, description: new[] {
@"Grants an effect which lasts while the Druid is within the respective shapeshift form.
...
Tree of Life/Caster Form - Increases healing by 4%.",})]
        public int MasterShapeshifter { get { return _data[48]; } set { _data[48] = value; } }
        /// <summary>
        /// Increases the effect of your Rejuvenation and Swiftmend spells by [5 * Pts]%.
        /// </summary>
        [TalentData(index: 49, name: "Improved Rejuvenation", maxPoints: 3, icon: "spell_nature_rejuvenation",
         tree: 2, column: 3, row: 2, prerequisite: -1, description: new[] {
...
@"Increases the effect of your Rejuvenation and Swiftmend spells by 15%.",})]
        public int ImprovedRejuvenation { get { return _data[49]; } set { _data[49] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 50, name: "Living Seed", maxPoints: 3, icon: "ability_druid_giftoftheearthmother",
         tree: 2, column: 1, row: 3, prerequisite: -1, description: new[] {
...
@"When you critically heal a target with Swiftmend, Regrowth, Nourish or Healing Touch spell you plant a Living Seed on the target for 30% of the amount healed. The Living Seed will bloom when the target is next attacked. Lasts 15 sec.",})]
        public int LivingSeed { get { return _data[50]; } set { _data[50] = value; } }
        /// <summary>
        ...
        /// Replenishment - Grants up to 10 party or raid members mana regeneration equal to 1% of the maximum mana per 10 sec. Lasts for 15 sec.
        /// </summary>
        [TalentData(index: 51, name: "Revitalize", maxPoints: 3, icon: "ability_druid_replenish",
         tree: 2, column: 2, row: 3, prerequisite: -1, description: new[] {
...
Replenishment - Grants up to 10 party or raid members mana regeneration equal to 1% of the maximum mana per 10 sec. Lasts for 15 sec.",})]
        public int Revitalize { get { return _data[51]; } set { _data[51] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 52, name: "Nature's Swiftness", maxPoints: 1, icon: "spell_nature_ravenform",
         tree: 2, column: 3, row: 3, prerequisite: -1, description: new[] {
@"Nature's Swiftness - 3 min cooldown - Instant
Requires Moonkin Form - When activated, your next Nature spell with a base casting time less than 10 sec. becomes an instant cast spell.",})]
        public int NaturesSwiftness { get { return _data[52]; } set { _data[52] = value; } }
        /// <summary>
        /// Reduces the mana cost of your Wrath spell by [50 * Pts]%, and when you deal damage with your Wrath spell you have a [15 * Pts]% chance to cause your next Starfire to be instant cast within 8 sec.
        /// </summary>
        [TalentData(index: 53, name: "Fury of Stormrage", maxPoints: 2, icon: "inv_staff_90",
         tree: 2, column: 4, row: 3, prerequisite: -1, description: new[] {
@"Reduces the mana cost of your Wrath spell by 50%, and when you deal damage with your Wrath spell you have a 15% chance to cause your next Starfire to be instant cast within 8 sec.",
@"Reduces the mana cost of your Wrath spell by 100%, and when you deal damage with your Wrath spell you have a 30% chance to cause your next Starfire to be instant cast within 8 sec.",})]
        public int FuryOfStormrage { get { return _data[53]; } set { _data[53] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 54, name: "Nature's Bounty", maxPoints: 3, icon: "spell_nature_resistnature",
         tree: 2, column: 2, row: 4, prerequisite: -1, description: new[] {
@"Increases the critical effect chance of your Regrowth spell by 20%, and you have a 33% chance when you critcially heal with Healing Touch and Nourish to reduce the remaining cooldown of your Swiftmend spell by 0.5 sec.",
...
@"Increases the critical effect chance of your Regrowth spell by 60%, and you have a 100% chance when you critically heal with Healing Touch and Nourish to reduce the remaining cooldown of your Swiftmend spell by 0.5 sec.",})]
        public int NaturesBounty { get { return _data[54]; } set { _data[54] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 55, name: "Empowered Touch", maxPoints: 2, icon: "ability_druid_empoweredtouch",
         tree: 2, column: 3, row: 4, prerequisite: -1, description: new[] {
...
@"Increases the healing done by your Healing Touch and Nourish spells by 10%, and your Nourish spell has a 100% chance to refresh the duration of your Lifebloom on targets.",})]
        public int EmpoweredTouch { get { return _data[55]; } set { _data[55] = value; } }
        /// <summary>
        /// Whenever you heal with your Lifebloom spell, you have a [3 * Pts]% chance to cause Omen of Clarity.
        /// </summary>
        [TalentData(index: 56, name: "Malfurion's Gift", maxPoints: 2, icon: "spell_shaman_giftearthmother",
         tree: 2, column: 4, row: 4, prerequisite: 53, description: new[] {
@"Whenever you heal with your Lifebloom spell, you have a 3% chance to cause Omen of Clarity.",
@"Whenever you heal with your Lifebloom spell, you have a 6% chance to cause Omen of Clarity.",})]
        public int MalfurionsGift { get { return _data[56]; } set { _data[56] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 57, name: "Efflorescence", maxPoints: 3, icon: "inv_misc_herb_talandrasrose",
         tree: 2, column: 1, row: 5, prerequisite: 50, description: new[] {
...
@"When you critically heal with your Regrowth spell you also sprout a bed of healing flora underneath the target, healing all nearby friendly targets within 4 yards for 30% of the amount healed by your Regrowth over 7 sec.",})]
        public int Efflorescence { get { return _data[57]; } set { _data[57] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 58, name: "Wild Growth", maxPoints: 1, icon: "ability_druid_flourish",
         tree: 2, column: 2, row: 5, prerequisite: -1, description: new[] {
@"Wild Growth - 40 yd range - 27% of base mana
10 sec cooldown - Instant cast
Heals up to 5 friendly party or raid members within 15 yards of the target for 686 over 7 sec.  Prioritizes healing most injured party members.  The amount healed is applied quickly at first, and slows down as the Wild Growth reaches its full duration.",})]
        public int WildGrowth { get { return _data[58]; } set { _data[58] = value; } }
        /// <summary>
        /// Empowers your Remove Corruption spell to also remove a magic effect from a friendly target.
        /// </summary>
        [TalentData(index: 59, name: "Nature's Cure", maxPoints: 1, icon: "ability_shaman_cleansespirit",
         tree: 2, column: 3, row: 5, prerequisite: -1, description: new[] {
@"Empowers your Remove Corruption spell to also remove a magic effect from a friendly target.",})]
        public int NaturesCure { get { return _data[59]; } set { _data[59] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 60, name: "Nature's Ward", maxPoints: 2, icon: "ability_druid_naturalperfection",
         tree: 2, column: 4, row: 5, prerequisite: -1, description: new[] {
...
@"Whenever you take an attack while at or below 50% health, you have a 100% chance to automatically cast Rejuvenation on yourself with no mana cost.",})]
        public int NaturesWard { get { return _data[60]; } set { _data[60] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 61, name: "Gift of the Earthmother", maxPoints: 3, icon: "ability_druid_manatree",
         tree: 2, column: 1, row: 6, prerequisite: -1, description: new[] {
...
@"Increases the healing done when your Lifebloom expires by 15%, and causes your Rejuvenation spell to also instantly heal for 15% of the total periodic effect.",})]
        public int GiftOfTheEarthmother { get { return _data[61]; } set { _data[61] = value; } }
        /// <summary>
        /// Reduces the global cooldown of your Rejuvenation by [0.2 * Pts] sec.
        /// </summary>
        [TalentData(index: 62, name: "Swift Rejuvenation", maxPoints: 2, icon: "ability_druid_empoweredrejuvination",
         tree: 2, column: 3, row: 6, prerequisite: -1, description: new[] {
@"Reduces the global cooldown of your Rejuvenation by 0.2 sec.",
@"Reduces the global cooldown of your Rejuvenation by 0.5 sec.",})]
        public int SwiftRejuvenation { get { return _data[62]; } set { _data[62] = value; } }
        /// <summary>
        ...
        /// </summary>
        [TalentData(index: 63, name: "Tree of Life", maxPoints: 1, icon: "ability_druid_treeoflife",
         tree: 2, column: 2, row: 7, prerequisite: 58, description: new[] {
@"Shapeshift - Tree of Life - 13% of base mana
5 min cooldown - Instant cast
Shapeshift into the tree of life, increasing healing done by 15% and increasing your armor by 120%. In addition, some of your spells are temporarly enhanced while shapeshifted. Lasts 45 sec.

Enhanced spells: Lifebloom, Wild Growth, Regrowth, Entangling Roots, Thorns, Wrath",})]
        public int TreeOfLife { get { return _data[63]; } set { _data[63] = value; } }
    }
