...
namespace Rawr
{
	...
	{   // Class only works for Level 80 Characters (Level 85 if you are in the Rawr4 projects)
		...
		public static float[] AGI_PER_PHYSICALCRIT = { 0.0f, // CharacterClass starts at 1
			3.905f * 62.500f,  // Warrior 1
			3.905f * 52.083f,  // Paladin 2
			3.905f * 83.333f,  // Hunter 3
			3.905f * 83.333f,  // Rogue 4
			3.905f * 52.083f,  // Priest 5
			3.905f * 62.500f,  // Death Knight 6
			3.905f * 83.333f,  // Shaman 7
			3.905f * 51.0204f, // Mage 8
			3.905f * 50.505f,  // Warlock 9
			3.905f *  0.000f,  // Empty 10
			3.905f * 83.333f,  // Druid 11
		};

		public static float[] AGI_PER_DODGE = { 0.0f, // Starts at 0
			5.309f * 84.74576271f, // Warrior 1
			5.309f * 59.88023952f, // Paladin 2
			5.309f * 86.20689655f, // Hunter 3
			5.309f * 47.84688995f, // Rogue 4
			5.309f * 59.88023952f, // Priest 5
			5.309f * 84.74576271f, // Death Knight 6
			5.309f * 59.88023952f, // Shaman 7
			5.309f * 58.82352941f, // Mage 8
			5.309f * 59.88023952f, // Warlock 9
			5.309f *  0.0f,        // Empty 10
			5.309f * 47.84688995f, // Druid 11
		};
