...
namespace Rawr.Enhance
{
    class Gemming
    {
        ...
        //Orange (R&Y)
        private int[] deadly = { 52109, 52209, 0, 52209 };    // Agi/Crit
        private int[] deft = { 52112, 52211, 0, 52211 };      // Agi/Haste
        private int[] adept = { 52115, 52204, 0, 52204 };     // Agi/Mast
        private int[] keen = { 52118, 52224, 0, 52224 };      // Exp/Mast
        ...
        private int[] senseis = { 52128, 52237, 0, 52237 }; // Mast/Hit
        ...
        public List<GemmingTemplate> addTemplates(String group, int rarity, int metagem, bool enabled)
        {
            return new List<GemmingTemplate>() {
            	...
            	new GemmingTemplate() { Model = "Enhance", Group = group, Enabled = enabled, //Max Expertise - colour match
					RedId = precise[rarity], YellowId = keen[rarity], BlueId = accurate[rarity], PrismaticId = precise[rarity], MetaId = metagem, CogwheelId = cog_precise },
            	new GemmingTemplate() { Model = "Enhance", Group = group, Enabled = enabled, //Max Expertise - no colour match
					RedId = precise[rarity], YellowId = precise[rarity], BlueId = precise[rarity], PrismaticId = precise[rarity], MetaId = metagem, CogwheelId = cog_precise },

            	new GemmingTemplate() { Model = "Enhance", Group = group, Enabled = enabled,  //Max Hit - red exp, yellow mast
					RedId = accurate[rarity], YellowId = senseis[rarity], BlueId = rigid[rarity], PrismaticId = rigid[rarity], MetaId = metagem, CogwheelId = cog_rigid },
            	new GemmingTemplate() { Model = "Enhance", Group = group, Enabled = enabled,  //Max Hit - red agi, yellow mast
					RedId = glinting[rarity], YellowId = senseis[rarity], BlueId = rigid[rarity], PrismaticId = rigid[rarity], MetaId = metagem, CogwheelId = cog_rigid },
            	new GemmingTemplate() { Model = "Enhance", Group = group, Enabled = enabled,  //Max Hit - no colour match
					RedId = rigid[rarity], YellowId = rigid[rarity], BlueId = rigid[rarity], PrismaticId = rigid[rarity], MetaId = metagem, CogwheelId = cog_rigid },

                new GemmingTemplate() { Model = "Enhance", Group = group, Enabled = enabled,  //Max Agility - yellow mast, cogwheel mast
					RedId = delicate[rarity], YellowId = adept[rarity], BlueId = glinting[rarity], PrismaticId = delicate[rarity], MetaId = metagem, CogwheelId = cog_fractured },
                new GemmingTemplate() { Model = "Enhance", Group = group, Enabled = enabled,  //Max Agility - yellow haste, cogwheel haste
					RedId = delicate[rarity], YellowId = deft[rarity], BlueId = glinting[rarity], PrismaticId = delicate[rarity], MetaId = metagem, CogwheelId = cog_quick },
                new GemmingTemplate() { Model = "Enhance", Group = group, Enabled = enabled,  //Max Agility - yellow crit, cogwheel crit
					RedId = delicate[rarity], YellowId = deadly[rarity], BlueId = glinting[rarity], PrismaticId = delicate[rarity], MetaId = metagem, CogwheelId = cog_smooth },
                ...
                new GemmingTemplate() { Model = "Enhance", Group = group, Enabled = enabled,  //Max Mastery - red agi, blue hit
					RedId = adept[rarity], YellowId = fractured[rarity], BlueId = senseis[rarity], PrismaticId = fractured[rarity], MetaId = metagem, CogwheelId = cog_fractured },
                ...
                new GemmingTemplate() { Model = "Enhance", Group = group, Enabled = enabled,  //Max Mastery - no colour match
					RedId = fractured[rarity], YellowId = fractured[rarity], BlueId = fractured[rarity], PrismaticId = fractured[rarity], MetaId = metagem, CogwheelId = cog_fractured },
            };
        }
    }
}
