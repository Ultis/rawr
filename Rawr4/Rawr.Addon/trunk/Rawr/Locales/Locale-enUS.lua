...
L["help_massive_upgrade_value"] = "Select the percentage above which to play the massive upgrade sound"
L["help_big_upgrade_value"] = "Select the percentage above which to play the big upgrade sound"
...
L["Alert %s is in your Rawr upgrade list."] = true