        ...
        private void Calculate() {
            ...
            switch (AttackModelMode) {
                ...
                case AttackModelMode.Devastate: {
                    ...
                    }else{goto case AttackModelMode.Basic;}
                    break;
                }
                ...
                case AttackModelMode.FullProtection: {
                    ...
                    // The cycle length is 4.7844s, abilities per cycle is 3.1896
                    if (Talents.SwordAndBoard == 3 && Talents.ConcussionBlow == 1 && Talents.Shockwave == 1) {
                ...
                case AttackModelMode.UnrelentingAssault: {
                    ...
                    if (Talents.UnrelentingAssault == 2) {
            ...
            // Vigilance
            if (Options.UseVigilance) { modelThreat += Abilities[Ability.Vigilance].Threat * modelLength; }
