namespace Rawr.DPSWarr
{
    public class CombatFactors
    {
        ...
        public float NormalizedMhWeaponDmg
        {
            get { return CalcNormalizedWeaponDamage(MainHand, _stats); }
        }

        public float AvgOhWeaponDmg
        {
            get { return CalcAverageWeaponDamage(OffHand, _stats)*(0.5f+_talents.DualWieldSpecialization*0.025f); }
        }

        public float NormalizedOhWeaponDmg
        {
            get { return CalcNormalizedWeaponDamage(OffHand, _stats); }
        }
        ...
        {
            get { return CalcDodgeChance(MhExpertise)/100; }
        }

        public float OhDodgeChance
        {
            get { return CalcDodgeChance(OhExpertise)/100; }
        }
        ...
        {
            get { return CalcYellowCrit(MainHand); }
        }
        ...
        {
            get { return CalcYellowCrit(OffHand); }
        }

        public float ProbMhWhiteHit
        {
            get { return 1f - WhiteMissChance - MhDodgeChance; }
        }

        public float ProbOhWhiteHit
        {
            get { return 1f - WhiteMissChance - OhDodgeChance; }
        }
        ...
        public float MainHandSpeed
        {
            get
            {
                return MainHand.Speed / TotalHaste;
            }
        }
        ...
        public float OffHandSpeed
        {
            get
            {
                return OffHand.Speed / TotalHaste;
            }
        }
        ...
        public float BonusYellowCritDmg
        {
            get { return BonusWhiteCritDmg*(1+_talents.Impale*0.1f); }
        }
        public float HitPercent
        {
            get
            {
                return _stats.PhysicalHit + _stats.HitRating * WarriorConversions.HitRatingToHit;
            }
        }
