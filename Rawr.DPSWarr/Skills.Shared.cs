    ...
    public class SpellDamageEffect : Ability
    {
        ...
        public override float DamageOverride
        {
            get
            {
                ...
                float dmg;
                if (Char.MainHand != null
                    && Char.MainHand.Item.Stats._rawSpecialEffectDataSize != 0
                    && Char.MainHand.Item.Stats._rawSpecialEffectData[0] != null)
                    dmg = Char.MainHand.Item.Stats._rawSpecialEffectData[0].Stats.ShadowDamage;
                else if (Char.OffHand != null
                    && Char.OffHand.Item.Stats._rawSpecialEffectDataSize != 0
                    && Char.OffHand.Item.Stats._rawSpecialEffectData[0] != null)
                    dmg = Char.OffHand.Item.Stats._rawSpecialEffectData[0].Stats.ShadowDamage;
                else return 0f;
