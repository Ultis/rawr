    ...
    public class FuryRotation : Rotation
    {
        ...
        public override void doIterations() {
            try
            {
                ...
                } while (Math.Abs(1f - (BS.Activates        != 0 ? oldBS / BS.Activates        : 1f)) > 0.05f ||
                         Math.Abs(1f - (HS.numActivates != 0 ? oldHS / HS.numActivates : 1f)) > 0.05f ||
                         Math.Abs(1f - (CL.numActivates != 0 ? oldCL / CL.numActivates : 1f)) > 0.05f);
