...
namespace Rawr
{
	public class Calculations
	{
		...
		public static ItemBuffEnchantCalculation GetItemCalculations(Item item, Character character, Character.CharacterSlot slot)
		{
			...
			{
				characterStatsWithSlotEmpty = GetCharacterCalculationsFromBasicStats(GetCharacterStats(characterWithSlotEmpty));
			...
			CharacterCalculation characterStatsWithNewItem = GetCharacterCalculationsFromBasicStats(GetCharacterStats(characterWithNewItem, additionalItem));
		...
		public static List<ItemBuffEnchantCalculation> GetEnchantCalculations(Item.ItemSlot slot, Character character, CharacterCalculation currentCalcs)
		{
			List<ItemBuffEnchantCalculation> enchantCalcs = new List<ItemBuffEnchantCalculation>();
			CharacterCalculation calcsEquipped = null;
			CharacterCalculation calcsUnequipped = null;
		...
		public static List<ItemBuffEnchantCalculation> GetBuffCalculations(Character character, CharacterCalculation currentCalcs, Buff.BuffType buffType, bool activeOnly)
		{
