...
{
	public class ElementalRotationCalculator
	{
		...
		public ElementalRotationCalculator(Stats stats, float duration, float cpPerCPG, bool maintainMangle, float mangleDuration,
		...
		public ElementalRotationCalculation GetRotationCalculations(bool useShred, bool useRip, bool useFerociousBite, int roarCP)
		{
			...
			return new ElementalRotationCalculation()
			{ 
		...
		public class ElementalRotationCalculation
		{
