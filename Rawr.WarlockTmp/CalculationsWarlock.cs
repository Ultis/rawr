...
namespace Rawr.WarlockTmp {
    ...
    public class CalculationsWarlock : CalculationsBase {
        ...
        /// <summary>
        /// GemmingTemplates to be used by default, when none are 
        /// defined
        /// </summary>
        ...
        /// An additional item to grant the Character the stats of (as
        /// if it were worn)
        /// </param>
        /// <returns>
        /// The CharacterCalculationsWarlock containing the results of 
        /// the calculations
        /// </returns>
        public override CharacterCalculationsBase
            ...
            CharacterCalculationsWarlock calculatedStats 
                = new CharacterCalculationsWarlock();
