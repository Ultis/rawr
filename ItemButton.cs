...
namespace Rawr
{
    public class ItemButton : Button, IItemProvider
    {
        ...
        public ItemButton()
        {
            Size = new Size(70, 70);
            //Text = string.Empty;
            MouseUp += new MouseEventHandler(ItemButton_MouseClick);
            MouseEnter += new EventHandler(ItemButton_MouseEnter);
            MouseLeave += new EventHandler(ItemButton_MouseLeave);
        ...
        public void UpdateSelectedItem()
        {
            ...
            Text = string.Empty;
            Image = _selectedItem != null ? ItemIcons.GetItemIcon(_selectedItem) : null;
        }
