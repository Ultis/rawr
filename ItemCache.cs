...
namespace Rawr
{
    public static class ItemCache
    {
        ...
        {
            return FindItemById(id.ToString() + ".0.0.0");
        }

        public static Item FindItemById(string gemmedId)
        {
            return FindItemById(gemmedId, true);
        }

        public static Item FindItemById(int id, bool createIfCorrectGemmingNotFound)
        {
            return FindItemById(id.ToString() + ".0.0.0", createIfCorrectGemmingNotFound);
        }
                                               ...
                                               item.Stats.Resilience), new Sockets(item.Sockets.Color1,
                                                                                   ...
                                                                                   new Stats(item.Sockets.Stats.Armor,
                                                                                             ...
                                                                                             item.Sockets.Stats.
                                                                                                 Resilience)),
                                     id1, id2, id3);
                            //FindItemById(id1) != null ? id1 : 0, FindItemById(id2) != null ? id2 : 0, FindItemById(id3) != null ? id3 : 0);
        ...
        public static void Save()
        {
            ...
            writer.Close();
            File.WriteAllText(Path.Combine(Path.GetDirectoryName(Application.ExecutablePath), "ItemCache.xml"),
                              sb.ToString());
        ...
        public static void Load()
        {
            ...
            {
                string xml =
                    File.ReadAllText(Path.Combine(Path.GetDirectoryName(Application.ExecutablePath), "ItemCache.xml")).
