...
namespace Rawr.Tree
{
    public class CharacterCalculationsTree : CharacterCalculationsBase
    {
        ...
        public override Dictionary<string, string> GetCharacterDisplayCalculationValues()
        {
            ...
            Spell2 spell = new Regrowth2(this);
            ...
            spell = new LifebloomStack2(this);
            ...
            dictValues.Add("HT HPS", Math.Round(spell.HPS, 2) + "*" + Math.Round(spell.castTime, 2) + "sec Casttime");
