...
namespace Rawr.Tree {
    ...
    public class HealingTouch : Spell {
        ...
        public override void applyStats(Stats stats)
        {
            ...
            critRatio = stats.SpellCrit + extraCrit;
    ...
    public class Rejuvenation : Spell {
        ...
        public override void applyStats(Stats stats)
        {
            ...
            critHoTRatio = stats.SpellCrit + extraCrit; // *stats.RejuvenationCrit;
            critRatio = critHoTRatio;   
    ...
    public class Swiftmend : Spell {
        ...
        public override String ToString() {  return base.ToString() + (druidTalents.Efflorescence>0? "\n Efflorescence: " + Math.Round(AverageHealing - beforeEfflorescence).ToString() + " with "+numMelee.ToString()+" melee" : ""); } 
        ...
        private void calculateTalents(DruidTalents druidTalents, CalculationOptionsTree calcOpts)
        {
            ...
            beforeEfflorescence = minHeal+coefDH*spellPower;
            minHeal *= 1.0f + numMelee * druidTalents.Efflorescence * 0.1f;     // Wowpedia lists it as 20% ? 
            maxHeal *= 1.0f + numMelee * druidTalents.Efflorescence * 0.1f;
            coefDH  *= 1.0f + numMelee * druidTalents.Efflorescence * 0.1f;
