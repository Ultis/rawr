...
namespace Rawr.Tree {
    ...
    public abstract class Spell {
        ...
        /// <summary>
        /// Total healing generated by this spell, includes base, crit and HoT effects on multiple targets
        /// </summary>
        public float TotalAverageHealing { get { return (AverageHealingwithCrit + PeriodicTickwithCrit * PeriodicTicks) * MaxTargets; } }
        ...
        public float HPS_HOT { get { return periodicTickTime > 0 ? PeriodicTickwithCrit * MaxTargets / periodicTickTime : 0; } }

        public float HPM { get { return TotalAverageHealing / ManaCost; } }
        public float HPM_DH { get { return AverageHealingwithCrit * MaxTargets / ManaCost; } }
        public float HPM_HOT { get { return PeriodicTickwithCrit * MaxTargets * PeriodicTicks / ManaCost; } }
        ...
        public float HPCT_DH { get { return AverageHealingwithCrit * MaxTargets / CastTime; } }
        public float HPCT_HOT { get { return PeriodicTickwithCrit * MaxTargets * PeriodicTicks / CastTime; } }
        ...
        public float NumHeals { get { return (PeriodicTicks + (AverageHealing > 0f ? 1f : 0f)) * MaxTargets; } }  // If we have a direct heal + num periodicTicks
        public float NumExpectedCrits { get { return (PeriodicTicks * CritHoTRatio + (AverageHealing > 0f ? 1.0f : 0f) * CritRatio) * MaxTargets; } }  // Weight number of heals by crit rates
    ...
    public class Lifebloom : Spell {
            ...
            : base(character, stats)
        {
            ...
            minHeal = 2306f * 0.8f;  // Patch 4.1 reduces bloom by 20%
            maxHeal = 2306f * 0.8f;  // Patch 4.1 reduces bloom by 20%
            coefDH = 0.355f * 0.8f;  // Patch 4.1 reduces bloom by 20%
    ...
    public class Efflorescence : Spell
    {
        ...
        public Efflorescence(Character character, Stats stats, Spell Rejuv)
            : base(character, stats) 
        {
...
//            alreadyHottedTarget = true;
            ...
            periodicTick = SM.MinHeal * druidTalents.Efflorescence * 0.04f;     // Patch 4.1
            coefHoT = SM.coefDH * druidTalents.Efflorescence * 0.04f;
