...
namespace Rawr
{
    ...
    public class Enchant
    {
        ...
        private static List<Enchant> GetDefaultEnchants()
        {
            ...
            defaultEnchants.Add(new Enchant(3818, "Arcanum of the Stalwart Protector", ItemSlot.Head, new Stats() { Stamina = 37, DodgeRating = 20 }));
            defaultEnchants.Add(new Enchant(3817, "Arcanum of Torment", ItemSlot.Head, new Stats() { AttackPower = 50, CritRating = 20 })); // Will probably be vamped again
            defaultEnchants.Add(new Enchant(3797, "Arcanum of Dominance", ItemSlot.Head, new Stats() { SpellPower = 29, Resilience = 20 })); // Will probably be vamped again
            ...
            defaultEnchants.Add(new Enchant(3795, "Arcanum of Triumph", ItemSlot.Head, new Stats() { AttackPower = 50, Resilience = 20 })); // Will probably be vamped again
            // Level 70 (BC)
            ...
            defaultEnchants.Add(new Enchant(3001, "Arcanum of Renewal", ItemSlot.Head, new Stats() { Intellect = 16, Spirit = 18 }));
            defaultEnchants.Add(new Enchant(3009, "Arcanum of Shadow Warding", ItemSlot.Head, new Stats() { ShadowResistance = 20 }));
            defaultEnchants.Add(new Enchant(2999, "Arcanum of the Defender", ItemSlot.Head, new Stats() { ParryRating = 16, DodgeRating = 17 }));
            ...
            #region Shoulders
            // Level 85 (Cataclysm)
            defaultEnchants.Add(new Enchant(4200, "Greater Inscription of Charged Lodestone", ItemSlot.Shoulders, new Stats() { Intellect = 50, HasteRating = 25 }));
            defaultEnchants.Add(new Enchant(4202, "Greater Inscription of Jagged Stone", ItemSlot.Shoulders, new Stats() { Strength = 50, CritRating = 25 }));
            defaultEnchants.Add(new Enchant(4204, "Greater Inscription of Shattered Crystal", ItemSlot.Shoulders, new Stats() { Agility = 50, MasteryRating = 25 }));
            defaultEnchants.Add(new Enchant(4198, "Greater Inscription of Unbreakable Quartz", ItemSlot.Shoulders, new Stats() { Stamina = 75, DodgeRating = 25 }));
            defaultEnchants.Add(new Enchant(4199, "Lesser Inscription of Charged Lodestone", ItemSlot.Shoulders, new Stats() { Intellect = 30, HasteRating = 20 }));
            defaultEnchants.Add(new Enchant(4201, "Lesser Inscription of Jagged Stone", ItemSlot.Shoulders, new Stats() { Strength = 30, CritRating = 20 }));
            defaultEnchants.Add(new Enchant(4205, "Lesser Inscription of Shattered Crystal", ItemSlot.Shoulders, new Stats() { Agility = 30, MasteryRating = 20 }));
            defaultEnchants.Add(new Enchant(4197, "Lesser Inscription of Unbreakable Quartz", ItemSlot.Shoulders, new Stats() { Stamina = 45, DodgeRating = 20 }));
            // Level 80 (WotLK)
            ...
            defaultEnchants.Add(new Enchant(3809, "Greater Inscription of the Crag", ItemSlot.Shoulders, new Stats() { Intellect = 21, Spirit = 16 }));
            defaultEnchants.Add(new Enchant(3811, "Greater Inscription of the Pinnacle", ItemSlot.Shoulders, new Stats() { DodgeRating = 20, Stamina = 22 }));
            ...
            defaultEnchants.Add(new Enchant(3807, "Lesser Inscription of the Crag", ItemSlot.Shoulders, new Stats() { Intellect = 15, Spirit = 10 }));
            defaultEnchants.Add(new Enchant(3876, "Lesser Inscription of the Pinnacle", ItemSlot.Shoulders, new Stats() { DodgeRating = 15, ParryRating = 10 }));
            ...
            defaultEnchants.Add(new Enchant(2980, "Greater Inscription of Faith", ItemSlot.Shoulders, new Stats() { Intellect = 15, Spirit = 10 }));
            ...
            defaultEnchants.Add(new Enchant(2991, "Greater Inscription of the Knight", ItemSlot.Shoulders, new Stats() { ParryRating = 15, DodgeRating = 10 }));
            defaultEnchants.Add(new Enchant(2993, "Greater Inscription of the Oracle", ItemSlot.Shoulders, new Stats() { Intellect = 10, Spirit = 16 }));
            ...
            defaultEnchants.Add(new Enchant(2978, "Greater Inscription of Warding", ItemSlot.Shoulders, new Stats() { DodgeRating = 15, Stamina = 15 }));
            defaultEnchants.Add(new Enchant(2998, "Inscription of Endurance", ItemSlot.Shoulders, new Stats() { NatureResistance = 7, ArcaneResistance = 7, FireResistance = 7, FrostResistance = 7, ShadowResistance = 7 }));
            ...
            defaultEnchants.Add(new Enchant(2605, "Zandalar Signet of Mojo", ItemSlot.Shoulders, new Stats() { SpellPower = 18 }));
            ...
            defaultEnchants.Add(new Enchant(1257, "Greater Arcane Resistance", ItemSlot.Back, new Stats() { ArcaneResistance = 15 }));
            ...
            defaultEnchants.Add(new Enchant(2648, "Steelweave", ItemSlot.Back, new Stats() { DodgeRating = 12 }));
            // Level 60 (Vanilla)
            ...
            #region Chest
            // Level 85 (Cataclysm)
            defaultEnchants.Add(new Enchant(4088, "Exceptional Spirit", ItemSlot.Chest, new Stats() { Spirit = 40 }));
            defaultEnchants.Add(new Enchant(4103, "Greater Stamina", ItemSlot.Chest, new Stats() { Stamina = 75 }));
            ...
            // Level 60 (Vanilla)
            // Unsorted
            defaultEnchants.Add(new Enchant(1950, "Major Defense", ItemSlot.Chest, new Stats() { DodgeRating = 15 }));
            defaultEnchants.Add(new Enchant(3150, "Restore Mana Prime", ItemSlot.Chest, new Stats() { Mp5 = 7f }));
            #endregion
            #region Wrist
            // Level 85 (Cataclysm)
            defaultEnchants.Add(new Enchant(4071, "Critical Strike", ItemSlot.Wrist, new Stats() { CritRating = 50 }));
            defaultEnchants.Add(new Enchant(4086, "Dodge", ItemSlot.Wrist, new Stats() { DodgeRating = 50 }));
            defaultEnchants.Add(new Enchant(4089, "Precision", ItemSlot.Wrist, new Stats() { HitRating = 50 }));
            defaultEnchants.Add(new Enchant(4093, "Exceptional Spirit", ItemSlot.Wrist, new Stats() { Spirit = 50 }));
            ...
            defaultEnchants.Add(new Enchant(2648, "Major Defense", ItemSlot.Wrist, new Stats() { DodgeRating = 12 }));
            ...
            #region Hands
            // Level 85 (Cataclysm)
            defaultEnchants.Add(new Enchant(4068, "Haste", ItemSlot.Hands, new Stats() { HasteRating = 50 }));
            defaultEnchants.Add(new Enchant(4075, "Exceptional Strength", ItemSlot.Hands, new Stats() { Strength = 35 }));
            defaultEnchants.Add(new Enchant(4082, "Greater Expertise", ItemSlot.Hands, new Stats() { ExpertiseRating = 50 }));
            defaultEnchants.Add(new Enchant(4107, "Greater Mastery", ItemSlot.Hands, new Stats() { MasteryRating = 65 }));
            defaultEnchants.Add(new Enchant(4106, "Mighty Strength", ItemSlot.Hands, new Stats() { Strength = 50 }));
            // Level 80 (WotLK)
            ...
            defaultEnchants.Add(new Enchant(4061, "Mastery", ItemSlot.Hands, new Stats() { MasteryRating = 50 }));
            ...
            Stats hyper = new Stats(); hyper.AddSpecialEffect(new SpecialEffect(Trigger.Use, new Stats() { HasteRating = 340f }, 12f, 60f));
            defaultEnchants.Add(new Enchant(3604, "Hyperspeed Accelerators", ItemSlot.Hands, hyper));
            Stats rockets = new Stats(); rockets.AddSpecialEffect(new SpecialEffect(Trigger.Use, new Stats() { FireDamage = 1837f, }, 0f, 45f));
            defaultEnchants.Add(new Enchant(3603, "Hand-Mounted Pyro Rocket", ItemSlot.Hands, rockets));
            #endregion
            #region Legs
            // Level 85 (Cataclysm)
            defaultEnchants.Add(new Enchant(4127, "Charscale Leg Armor", ItemSlot.Legs, new Stats() { Agility = 55, Stamina = 145 })); // LW Only
            defaultEnchants.Add(new Enchant(4126, "Dragonscale Leg Armor", ItemSlot.Legs, new Stats() { AttackPower = 190, CritRating = 55 })); // LW Only
            defaultEnchants.Add(new Enchant(4124, "Twilight Leg Armor", ItemSlot.Legs, new Stats() { Agility = 45, Stamina = 85 })); // LW Only
            defaultEnchants.Add(new Enchant(4122, "Scorched Leg Armor", ItemSlot.Legs, new Stats() { AttackPower = 110, CritRating = 45 })); // LW Only
            defaultEnchants.Add(new Enchant(4112, "Powerful Enchanted Spellthread", ItemSlot.Legs, new Stats() { Intellect = 95, Stamina = 80 }));
            defaultEnchants.Add(new Enchant(4110, "Powerful Ghostly Spellthread", ItemSlot.Legs, new Stats() { Intellect = 95, Spirit = 55 }));
            defaultEnchants.Add(new Enchant(4111, "Enchanted Spellthread", ItemSlot.Legs, new Stats() { Intellect = 55, Stamina = 65 }));
            defaultEnchants.Add(new Enchant(4109, "Ghostly Spellthread", ItemSlot.Legs, new Stats() { Intellect = 55, Spirit = 45 }));
            defaultEnchants.Add(new Enchant(4114, "Sanctified Spellthread (Rank 2)", ItemSlot.Legs, new Stats() { Intellect = 95, Spirit = 55 })); // Tailor Only
            defaultEnchants.Add(new Enchant(4113, "Master's Spellthread (Rank 2)", ItemSlot.Legs, new Stats() { Intellect = 95f, Stamina = 80f })); // Tailor Only
            // Level 80 (WotLK)
            defaultEnchants.Add(new Enchant(3853, "Earthen Leg Armor", ItemSlot.Legs, new Stats() { Resilience = 40, Stamina = 28 }));
            ...
            defaultEnchants.Add(new Enchant(3327, "Jormungar Leg Reinforcements", ItemSlot.Legs, new Stats() { Agility = 22, Stamina = 55 })); // LW Only
            defaultEnchants.Add(new Enchant(3328, "Nerubian Leg Reinforcements", ItemSlot.Legs, new Stats() { AttackPower = 75, CritRating = 22 })); // LW Only
            ...
            defaultEnchants.Add(new Enchant(3872, "Sanctified Spellthread (Rank 1)", ItemSlot.Legs, new Stats() { SpellPower = 50, Spirit = 20 })); // Tailor Only
            defaultEnchants.Add(new Enchant(3873, "Master's Spellthread (Rank 1)", ItemSlot.Legs, new Stats() { SpellPower = 50f, Stamina = 30f })); // Tailor Only
            // Level 70 (BC)
            ...
            #region Feet
            // Level 85 (Cataclysm)
            defaultEnchants.Add(new Enchant(4069, "Haste", ItemSlot.Feet, new Stats() { HasteRating = 50 }));
            defaultEnchants.Add(new Enchant(4076, "Major Agility", ItemSlot.Feet, new Stats() { Agility = 35 }));
            defaultEnchants.Add(new Enchant(4092, "Precision", ItemSlot.Feet, new Stats() { HitRating = 50 }));
            defaultEnchants.Add(new Enchant(4094, "Mastery", ItemSlot.Feet, new Stats() { MasteryRating = 50 }));
            defaultEnchants.Add(new Enchant(4105, "Assassin's Step", ItemSlot.Feet, new Stats() { Agility = 25, MovementSpeed = 0.08f }));
            defaultEnchants.Add(new Enchant(4104, "Lavawalker", ItemSlot.Feet, new Stats() { MasteryRating = 35, MovementSpeed = 0.08f }));
            defaultEnchants.Add(new Enchant(4062, "Earthen Vitality", ItemSlot.Feet, new Stats() { Stamina = 30, MovementSpeed = 0.08f }));
            // Level 80 (WotLK)
            ...
            // Unsorted
            Stats nitro = new Stats() { CritRating = 24f, }; nitro.AddSpecialEffect(new SpecialEffect(Trigger.Use, new Stats() { MovementSpeed = 1.50f, }, 5f, 3 * 60f));
            defaultEnchants.Add(new Enchant(3606, "Nitro Boosts", ItemSlot.Feet, nitro));
            #endregion
            #region Finger
            // Level 85 (Cataclysm)
            defaultEnchants.Add(new Enchant(4079, "Agility", ItemSlot.Finger, new Stats() { Agility = 40 }));
            defaultEnchants.Add(new Enchant(4081, "Greater Stamina", ItemSlot.Finger, new Stats() { Stamina = 60 }));
            defaultEnchants.Add(new Enchant(4080, "Intellect", ItemSlot.Finger, new Stats() { Intellect = 40 }));
            defaultEnchants.Add(new Enchant(4078, "Strength", ItemSlot.Finger, new Stats() { Strength = 40 }));
            // Level 80 (WotLK)
            ...
            #region Two Handers
            // Level 85 (Cataclysm)
            defaultEnchants.Add(new Enchant(4227, "Mighty Agility", ItemSlot.TwoHand, new Stats() { Agility = 130 }));
            // Level 80 (WotLK)
            ...
            //defaultEnchants.Add(new Enchant(3827, "Scourgebane", ItemSlot.TwoHand, new Stats() { AttackPowerAgainstUndead = 140 })); // No modelling
            ...
            // Level 60 (Vanilla)
            defaultEnchants.Add(new Enchant(241, "Minor Impact", ItemSlot.TwoHand, new Stats() { WeaponDamage = 2 }));
            defaultEnchants.Add(new Enchant(943, "Lesser Impact", ItemSlot.TwoHand, new Stats() { WeaponDamage = 3 }));
            defaultEnchants.Add(new Enchant(1897, "Impact", ItemSlot.TwoHand, new Stats() { WeaponDamage = 5 }));
            defaultEnchants.Add(new Enchant(963, "Greater Impact", ItemSlot.TwoHand, new Stats() { WeaponDamage = 7 }));
            defaultEnchants.Add(new Enchant(1896, "Superior Impact", ItemSlot.TwoHand, new Stats() { WeaponDamage = 9 }));
            defaultEnchants.Add(new Enchant(2646, "Agility", ItemSlot.TwoHand, new Stats() { Agility = 25 }));
            defaultEnchants.Add(new Enchant(1903, "Major Spirit", ItemSlot.TwoHand, new Stats() { Spirit = 9 }));
            defaultEnchants.Add(new Enchant(1904, "Major Intellect", ItemSlot.TwoHand, new Stats() { Intellect = 9 }));
            // Unsorted
            #endregion
            #region One Handers (Any of these can also go on TwoHanders)
            // Level 85 (Cataclysm)
            { Stats Hurricane = new Stats() { };
              Hurricane.AddSpecialEffect(new SpecialEffect(Trigger.MeleeHit, new Stats() { HasteRating = 450, }, 12, 45, 0.10f)); // read info off of cata.wowhead.com
              Hurricane.AddSpecialEffect(new SpecialEffect(Trigger.SpellCast, new Stats() { HasteRating = 450, }, 12, 45, 0.10f)); // read info off of cata.wowhead.com
              defaultEnchants.Add(new Enchant(4083, "Hurricane", ItemSlot.OneHand, Hurricane)); }
            { Stats Heartsong = new Stats() { };
              Heartsong.AddSpecialEffect(new SpecialEffect(Trigger.SpellCast, new Stats() { Spirit = 200, }, 15, 20, 0.25f)); // read info off of cata.wowhead.com
              defaultEnchants.Add(new Enchant(4084, "Heartsong", ItemSlot.OneHand, Heartsong)); }
            { Stats Landslide = new Stats() { };
              Landslide.AddSpecialEffect(new SpecialEffect(Trigger.MeleeHit, new Stats() { AttackPower = 1000, }, 12, 0f, -1f)); // read info off of cata.wowhead.com, and based proc times off of berserking
              defaultEnchants.Add(new Enchant(4099, "Landslide", ItemSlot.OneHand, Landslide)); }
            { Stats PowerTorrent = new Stats() { };
              PowerTorrent.AddSpecialEffect(new SpecialEffect(Trigger.DamageOrHealingDone, new Stats() { Intellect = 500, }, 12, 0f, -1f)); // read info off of cata.wowhead.com
              defaultEnchants.Add(new Enchant(4097, "Power Torrent", ItemSlot.OneHand, PowerTorrent)); }
            { Stats Windwalk = new Stats() { };
              Windwalk.AddSpecialEffect(new SpecialEffect(Trigger.MeleeHit, new Stats() { DodgeRating = 600, MovementSpeed = 0.15f }, 10, 45f, 0.10f)); // read info off of cata.wowhead.com
              defaultEnchants.Add(new Enchant(2668, "Windwalk", ItemSlot.OneHand, Windwalk)); }
            { Stats Avalanche = new Stats();
              Avalanche.AddSpecialEffect(new SpecialEffect(Trigger.MeleeHit, new Stats() { NatureDamage = 500f, }, 10f, 0f, -5f)); // 5 PPM
              defaultEnchants.Add(new Enchant(4067, "Avalanche", ItemSlot.OneHand, Avalanche)); }
            ...
            { Stats icebreaker = new Stats();
              icebreaker.AddSpecialEffect(new SpecialEffect(Trigger.MeleeHit, new Stats() { FireDamage = 200f, }, 0f, 0f, -3)); // 3 PPM = 9% Chance to proc
              defaultEnchants.Add(new Enchant(3239, "Icebreaker", ItemSlot.OneHand, icebreaker)); }
            { Stats lifeward = new Stats();
              lifeward.AddSpecialEffect(new SpecialEffect(Trigger.MeleeHit, new Stats() { HealthRestore = 333f, }, 0f, 0f, -4.6f)); // 4.6 PPM
              defaultEnchants.Add(new Enchant(3241, "Lifeward", ItemSlot.OneHand, lifeward)); }
            ...
            { Stats bladeWard = new Stats();
              bladeWard.AddSpecialEffect(new SpecialEffect(Trigger.MeleeHit, new Stats() { ParryRating = 200f, }, 10f, 0f, -1f)); // Need to add the 600-800 Physical Damage on next Parry
            ...
            // Level 85 (Cataclysm)
            defaultEnchants.Add(new Enchant(4073, "Protection", ItemSlot.OffHand, new Stats() { BonusArmor = 160 }));
            defaultEnchants.Add(new Enchant(4085, "Blocking", ItemSlot.OffHand, new Stats() { BlockRating = 40 }));
            defaultEnchants.Add(new Enchant(4091, "Superior Intellect", ItemSlot.OffHand, new Stats() { Intellect = 35 }));
            // Level 80 (WotLK)
            defaultEnchants.Add(new Enchant(1128, "Greater Intellect", ItemSlot.OffHand, new Stats() { Intellect = 25 }));
            defaultEnchants.Add(new Enchant(1952, "Defense", ItemSlot.OffHand, new Stats() { DodgeRating = 20 }));
            // Level 70 (BC)
            defaultEnchants.Add(new Enchant(2653, "Tough Shield", ItemSlot.OffHand, new Stats() { DodgeRating = 12 }));
            ...
            defaultEnchants.Add(new Enchant(2655, "Shield Block", ItemSlot.OffHand, new Stats() { ParryRating = 15 }));
            defaultEnchants.Add(new Enchant(1888, "Resistance", ItemSlot.OffHand, new Stats() { ShadowResistance = 5, ArcaneResistance = 5, NatureResistance = 5, FireResistance = 5, FrostResistance = 5 }));
            // Level 60 (Vanilla)
            // Unsorted
            ...
            // Level 85 (Cataclysm)
            defaultEnchants.Add(new Enchant(4121, "Heavy Savage Armor Kit", ItemSlot.Chest, new Stats() { Stamina = 44 }));
            defaultEnchants.Add(new Enchant(4121, "Heavy Savage Armor Kit", ItemSlot.Legs, new Stats() { Stamina = 44 }));
            defaultEnchants.Add(new Enchant(4121, "Heavy Savage Armor Kit", ItemSlot.Hands, new Stats() { Stamina = 44 }));
            defaultEnchants.Add(new Enchant(4121, "Heavy Savage Armor Kit", ItemSlot.Feet, new Stats() { Stamina = 44 }));
            defaultEnchants.Add(new Enchant(4121, "Heavy Savage Armor Kit", ItemSlot.Head, new Stats() { Stamina = 44 }));
            defaultEnchants.Add(new Enchant(4121, "Heavy Savage Armor Kit", ItemSlot.Shoulders, new Stats() { Stamina = 44 }));
            defaultEnchants.Add(new Enchant(4120, "Savage Armor Kit", ItemSlot.Chest, new Stats() { Stamina = 36 }));
            defaultEnchants.Add(new Enchant(4120, "Savage Armor Kit", ItemSlot.Legs, new Stats() { Stamina = 36 }));
            defaultEnchants.Add(new Enchant(4120, "Savage Armor Kit", ItemSlot.Hands, new Stats() { Stamina = 36 }));
            defaultEnchants.Add(new Enchant(4120, "Savage Armor Kit", ItemSlot.Feet, new Stats() { Stamina = 36 }));
            defaultEnchants.Add(new Enchant(4120, "Savage Armor Kit", ItemSlot.Head, new Stats() { Stamina = 36 }));
            defaultEnchants.Add(new Enchant(4120, "Savage Armor Kit", ItemSlot.Shoulders, new Stats() { Stamina = 36 }));
            // Level 80 (WotLK)
            ...
            // Level 70 (BC)
            // Level 60 (Vanilla)
            defaultEnchants.Add(new Enchant(2583, "Presence of Might", ItemSlot.Head, new Stats() { Stamina = 10, DodgeRating = 10, ParryRating = 10 }));
            defaultEnchants.Add(new Enchant(2583, "Presence of Might", ItemSlot.Legs, new Stats() { Stamina = 10, DodgeRating = 10, ParryRating = 10 }));
            defaultEnchants.Add(new Enchant(2543, "Arcanum of Rapidity", ItemSlot.Head, new Stats() { HasteRating = 10 }));
            defaultEnchants.Add(new Enchant(2543, "Arcanum of Rapidity", ItemSlot.Legs, new Stats() { HasteRating = 10 }));
