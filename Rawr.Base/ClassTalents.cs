...
namespace Rawr
{
    ...
    public class PriestTalents : TalentsBase, ICloneable
    {
        ...
        public PriestTalents(string talents)
        {
            ...
            data.CopyTo(0, _data, 0, Math.Min(_data.Length, data.Count));
        }
...
@"Increases the effect of your Inner Fire spell by 15%, and increases the total number of charges by 8.",
@"Increases the effect of your Inner Fire spell by 15%, and increases the total number of charges by 12.",})]
...
@"Gives you a 100% chance to gain the Focused Casting effect that lasts for 6 sec after being the victim of a melee or ranged critical strike. The Focused Casting effect prevents you from losing casting time when taking damage and increases resistance to Interrupt effects by 20%.",})]
        ...
        [TalentData(6, "Improved Inner Fire", 3, 0, 1, 3, -1, new string[] {
...
@"Increases the armor bonus and bonus healing of your Inner Fire spell by 30%.",})]
        public int ImprovedInnerFire { get { return _data[6]; } set { _data[6] = value; } }
...
@"Your Divine Spirit and Prayer of Spirit spells also increase the target's spell damage by an amount equal to 50% of thei Spirit granted.",
...
@"Gives you a 10% chance to enter a Clearcasting state after casting any Flash Heal, Binding Heal, or Greater Heal spell.  The Clearcasting state reduces the mana cost of your next Flash Heal, Binding Heal, or Greater Heal spell by 100%.",
@"Gives you a 20% chance to enter a Clearcasting state after casting any Flash Heal, Binding Heal, or Greater Heal spell.  The Clearcasting state reduces the mana cost of your next Flash Heal, Binding Heal, or Greater Heal spell by 100%.",
@"Gives you a 30% chance to enter a Clearcasting state after casting any Flash Heal, Binding Heal, or Greater Heal spell.  The Clearcasting state reduces the mana cost of your next Flash Heal, Binding Heal, or Greater Heal spell by 100%.",})]
...
@"Increases the critical strike damage bonus of your Mind Blast and Shadow Word: Death spells by 20%.",
@"Increases the critical strike damage bonus of your Mind Blast and Shadow Word: Death spells by 40%.",
@"Increases the critical strike damage bonus of your Mind Blast and Shadow Word: Death spells by 60%.",
@"Increases the critical strike damage bonus of your Mind Blast and Shadow Word: Death spells by 80%.",
@"Increases the critical strike damage bonus of your Mind Blast and Shadow Word: Death spells by 100%.",})]
...
@"Increases your spell power by 2% of your total Spirit, and your damage done by your Mind Flay and Mind Blast is increased by 2% if your target is afflicted by yoru Shadow Word: Pain.",
@"Increases your spell power by 4% of your total Spirit, and your damage done by your Mind Flay and Mind Blast is increased by 4% if your target is afflicted by yoru Shadow Word: Pain.",
@"Increases your spell power by 6% of your total Spirit, and your damage done by your Mind Flay and Mind Blast is increased by 6% if your target is afflicted by yoru Shadow Word: Pain.",
@"Increases your spell power by 8% of your total Spirit, and your damage done by your Mind Flay and Mind Blast is increased by 8% if your target is afflicted by yoru Shadow Word: Pain.",
@"Increases your spell power by 10% of your total Spirit, and your damage done by your Mind Flay and Mind Blast is increased by 10% if your target is afflicted by yoru Shadow Word: Pain.",})]
...
@"Your damaging Scorch spells have a 33% chance to cause your target to be vulnerable to spell damage, increasing spell critical strike chance against that target by 2% andlasts 30 sec. Stacks up to 5 times.",
@"Your damaging Scorch spells have a 66% chance to cause your target to be vulnerable to spell damage, increasing spell critical strike chance against that target by 2% andlasts 30 sec. Stacks up to 5 times.",
@"Your damaging Scorch spells have a 100% chance to cause your target to be vulnerable to spell damage, increasing spell critical strike chance against that target by 2% andlasts 30 sec. Stacks up to 5 times.",})]
...
@"Your Felhunter regains 4% of its maximum mana each time it hits with its Shadow Bit ability, and increases the effect of yoru Felhunter's Fel Intelligence by 5%.",
@"Your Felhunter regains 8% of its maximum mana each time it hits with its Shadow Bit ability, and increases the effect of yoru Felhunter's Fel Intelligence by 10%.",})]
...
@"Increases the effectiveness of your Demon Armor and Fel Armor spells by 30%.",})]
        ...
        [TalentData(38, "Unholy Power", 5, 1, 2, 4, -1, new string[] {
...
@"Increases the duration of your Moonfire, Insect Swarm, Rejuvenation spells by 3 sec, your Regrowth spell by 6 sec, and your Lifebloom spell by 3 sec.",})]
...
@"Increases your attack power in Bear Form and Dire Bear Form by 4%, and for each friendly player in your party when you enter Bear Form or Dire Bear Form, damage you take is reduced while in Bear Form and Dire Bear Form by 3%.",
...
@"While in Cat Form, Bear Form, or Dire Bear Form, increases your damage from melee critical strikes by 3% and your chance to avoid area effect attacks by 5%.",
@"While in Cat Form, Bear Form, or Dire Bear Form, increases your damage from melee critical strikes by 7% and your chance to avoid area effect attacks by 10%.",
...
@"1363 Mana,40 yd range,
Instant cast
Heals up to 5 friendly party or raid members within 15 yards of the target for 350 over 7 sec. The amount healed is applied quickly at first, and slows down as the Wild Growth reaches its full duration.",})]
...
@"Your melee critical strikes have a 33% chance to give you 1 energy.",
@"Your melee critical strikes have a 66% chance to give you 2 energy.",
@"Your melee critical strikes have a 100% chance to give you 3 energy.",})]
...
@"Increases your Dodge chance by 5%.",})]
        ...
        [TalentData(39, "Mace Specialization", 5, 1, 1, 5, -1, new string[] {
...
@"Your attacks with maces ignore up to 15% of your opponents armor.",})]
        public int MaceSpecialization { get { return _data[39]; } set { _data[39] = value; } }

        [TalentData(40, "Blade Flurry", 1, 1, 2, 5, -1, new string[] {
@"25 Energy
Instant,2 min cooldown,
Increases your attack speed by 20%. In addition, attacks strike an additional nearby opponent. Lasts 15 sec.",})]
        public int BladeFlurry { get { return _data[40]; } set { _data[40] = value; } }

        [TalentData(41, "Sword Specialization", 5, 1, 3, 5, -1, new string[] {
...
@"Gives you a 5% chance to get an extra attack on the same target after hitting your target with your Sword.",})]
        public int SwordSpecialization { get { return _data[41]; } set { _data[41] = value; } }

        [TalentData(42, "Aggression", 5, 1, 4, 5, -1, new string[] {
...
@"Increases the damage of your Sinister Strike, Backstab, and Eviscerate abilities by 10%.",})]
        public int Aggression { get { return _data[42]; } set { _data[42] = value; } }

        [TalentData(43, "Weapon Expertise", 2, 1, 2, 6, 40, new string[] {
...
@"Increases your pet's damage by 4% and you and your pet's movement speed by 2% while your pet is active.",
@"Increases your pet's damage by 8% and you and your pet's movement speed by 2% while your pet is active.",
@"Increases your pet's damage by 12% and you and your pet's movement speed by 2% while your pet is active.",
@"Increases your pet's damage by 16% and you and your pet's movement speed by 2% while your pet is active.",
@"Increases your pet's damage by 20% and you and your pet's movement speed by 2% while your pet is active.",})]
...
@"Your Immolation Trap, Explosive Trap and Explosive Shot have a 5% chance to stun targets for 3 sec when they deal damage, and increases the critical strike chance of your Explosive Shot and Explosive Trap by 3%.",
@"Your Immolation Trap, Explosive Trap and Explosive Shot have a 10% chance to stun targets for 3 sec when they deal damage, and increases the critical strike chance of your Explosive Shot and Explosive Trap by 6%.",
@"Your Immolation Trap, Explosive Trap and Explosive Shot have a 15% chance to stun targets for 3 sec when they deal damage, and increases the critical strike chance of your Explosive Shot and Explosive Trap by 9%.",})]
...
@"Reduces the mana cost of your Shock, Lightning Bolt, Chain Lightning, Thunder and Lava Lash spells by 2%.",
@"Reduces the mana cost of your Shock, Lightning Bolt, Chain Lightning, Thunder and Lava Lash spells by 4%.",
@"Reduces the mana cost of your Shock, Lightning Bolt, Chain Lightning, Thunder and Lava Lash spells by 6%.",
@"Reduces the mana cost of your Shock, Lightning Bolt, Chain Lightning, Thunder and Lava Lash spells by 8%.",
@"Reduces the mana cost of your Shock, Lightning Bolt, Chain Lightning, Thunder and Lava Lash spells by 10%.",})]
        public int Convection { get { return _data[0]; } set { _data[0] = value; } }

        [TalentData(1, "Concussion", 5, 0, 3, 1, -1, new string[] {
@"Increases the damage done by your Lightning Bolt, Chain Lightning, Thunderstorm, Lava Lash and Shock spells by 1%.",
@"Increases the damage done by your Lightning Bolt, Chain Lightning, Thunderstorm, Lava Lash and Shock spells by 2%.",
@"Increases the damage done by your Lightning Bolt, Chain Lightning, Thunderstorm, Lava Lash and Shock spells by 3%.",
@"Increases the damage done by your Lightning Bolt, Chain Lightning, Thunderstorm, Lava Lash and Shock spells by 4%.",
@"Increases the damage done by your Lightning Bolt, Chain Lightning, Thunderstorm, Lava Lash and Shock spells by 5%.",})]
        public int Concussion { get { return _data[1]; } set { _data[1] = value; } }

        [TalentData(2, "Call of Flame", 3, 0, 1, 2, -1, new string[] {
@"Increases the damage done by your Fire Totems by 5%, and damage done by your Lava Lash spell by 2%.",
@"Increases the damage done by your Fire Totems by 10%, and damage done by your Lava Lash spell by 4%.",
@"Increases the damage done by your Fire Totems by 15%, and damage done by your Lava Lash spell by 6%.",})]
...
@"Reduces the pushback suffered from damaging attacks while casting Lightning Bolt, Chain Lightning, Lava Lash and Hex spells by 23%.",
@"Reduces the pushback suffered from damaging attacks while casting Lightning Bolt, Chain Lightning, Lava Lash and Hex spells by 46%.",
@"Reduces the pushback suffered from damaging attacks while casting Lightning Bolt, Chain Lightning, Lava Lash and Hex spells by 70%.",})]
...
@"Increases the range of your Lightning Bolt and Chain Lightning spells by 6 yards, and increases the radius of your Thunderstorm spell by 20%.",})]
        ...
        [TalentData(11, "Call of Thunder", 1, 0, 2, 5, -1, new string[] {
@"Increases the critical strike chance of your Lightning Bolt and Chain Lightning and Thunderstorm spells by an additional 5%.",})]
...
Instant cast
Tools: Fire Totem
Summons a Totem of Wrath with 5 health at the feet of the caster. The totem increases the damage done by spells and effects by 100 for all party and raid members, and increasing the critical strike chance of spells and effects by 3% against all enemieswithin 40 yards. Lasts 5 min.",})]
        public int TotemOfWrath { get { return _data[20]; } set { _data[20] = value; } }

        [TalentData(21, "Lava Flows", 3, 0, 3, 9, -1, new string[] {
@"Increases the range of your Flame Shock by 5 yards, and increases the critical strike damage bonus of your Lava Lash spell by an additional 6%.",
@"Increases the range of your Flame Shock by 5 yards, and increases the critical strike damage bonus of your Lava Lash spell by an additional 12%.",
@"Increases the range of your Flame Shock by 5 yards, and increases the critical strike damage bonus of your Lava Lash spell by an additional 24%.",})]
...
@"Causes your critical hits with melee attacks to increase all party members' attack power by 10% if within 20 yards of the Shaman. Lasts 10 sec.",})]
        ...
        [TalentData(40, "Weapon Mastery", 5, 1, 3, 6, -1, new string[] {
...
@"When you critically hit with a melee weapon, you reduce the cast time of your next Lightning Bolt, Chain Lightning or Lava Lash Spell by 4%. Stacks up to 5 times. Lasts 15 seconds.",
@"When you critically hit with a melee weapon, you reduce the cast time of your next Lightning Bolt, Chain Lightning or Lava Lash Spell by 8%. Stacks up to 5 times. Lasts 15 seconds.",
@"When you critically hit with a melee weapon, you reduce the cast time of your next Lightning Bolt, Chain Lightning or Lava Lash Spell by 12%. Stacks up to 5 times. Lasts 15 seconds.",
@"When you critically hit with a melee weapon, you reduce the cast time of your next Lightning Bolt, Chain Lightning or Lava Lash Spell by 16%. Stacks up to 5 times. Lasts 15 seconds.",
@"When you critically hit with a melee weapon, you reduce the cast time of your next Lightning Bolt, Chain Lightning or Lava Lash Spell by 20%. Stacks up to 5 times. Lasts 15 seconds.",})]
...
@"You retain up to an additional 10 of your rage points when you change stances. Also greatly increases the threat generated by your Bloodthirst and Mortal Strike abilities when you are in Defensive Stance.",
...
@"Increases your Strength by 1 for every 400 armor value you have.",
@"Increases your Strength by 2 for every 400 armor value you have.",
@"Increases your Strength by 3 for every 400 armor value you have.",})]
...
@"Reduces the rage cost of your Slam, Whirlwind and Bloodthirst abilities by 1.",
@"Reduces the rage cost of your Slam, Whirlwind and Bloodthirst abilities by 2.",
@"Reduces the rage cost of your Slam, Whirlwind and Bloodthirst abilities by 3.",
@"Reduces the rage cost of your Slam, Whirlwind and Bloodthirst abilities by 4.",
@"Reduces the rage cost of your Slam, Whirlwind and Bloodthirst abilities by 5.",})]
...
@"Increases your total Strength by 2% and your Expertise by 2.",
@"Increases your total Strength by 4% and your Expertise by 4.",
@"Increases your total Strength by 6% and your Expertise by 6.",})]
...
@"Whenever you have no Runes active, your Parry chance increases by 2% for the next 10 sec.",
@"Whenever you have no Runes active, your Parry chance increases by 4% for the next 10 sec.",
@"Whenever you have no Runes active, your Parry chance increases by 6% for the next 10 sec.",
@"Whenever you have no Runes active, your Parry chance increases by 8% for the next 10 sec.",
@"Whenever you have no Runes active, your Parry chance increases by 10% for the next 10 sec.",})]
        public int BladeBarrier { get { return _data[2]; } set { _data[2] = value; } }

        [TalentData(3, "Bladed Armor", 5, 0, 1, 2, -1, new string[] {
@"Increases you Strength by 1 for every 400 armor value you have.",
@"Increases you Strength by 2 for every 400 armor value you have.",
@"Increases you Strength by 3 for every 400 armor value you have.",
@"Increases you Strength by 4 for every 400 armor value you have.",
@"Increases you Strength by 5 for every 400 armor value you have.",})]
...
@"Increases the damage by 12% and the bonus damage from diseases by 20% of your Blood Strike and Heart strike.",
@"Increases the damage by 18% and the bonus damage from diseases by 20% of your Blood Strike and Heart strike.",})]
...
@"Gives you a 1% bonus to Physical Frost and Shadow damage you deal for 30 sec after dealing a critical strike from a weapon swing, spell, or ability. This effect stacks up to 3 times.",
@"Gives you a 2% bonus to Physical Frost and Shadow damage you deal for 30 sec after dealing a critical strike from a weapon swing, spell, or ability. This effect stacks up to 3 times.",
@"Gives you a 3% bonus to Physical Frost and Shadow damage you deal for 30 sec after dealing a critical strike from a weapon swing, spell, or ability. This effect stacks up to 3 times.",})]
...
@"In addition, all party party or raid members within 45 yards of the Death Knight are healed by 1% of the damage they deal. Only damage dealt to targets that grant experience or honor can trigger this heal.",
@"In addition, all party or raid members within 45 yards of the Death Knight are healed by 2% of the damage they deal. Only damage dealt to targets that grant experience or honor can trigger this heal.",})]
