		...
		public static List<Enchant> AllEnchants
		{
			get
			{
				if (_allEnchants == null)
				{
					...
					_allEnchants.Add(new Enchant(2661, "Exceptional Stats", Item.ItemSlot.Chest, new Stats(0, 0, 6, 6, 0, 0, 0)));
					_allEnchants.Add(new Enchant(2933, "Major Resilience", Item.ItemSlot.Chest, new Stats(0, 0, 0, 0, 0, 0, 15)));
					_allEnchants.Add(new Enchant(2793, "Vindicator's Armor Kit", Item.ItemSlot.Chest, new Stats(0, 0, 0, 0, 0, 8, 0)));
					_allEnchants.Add(new Enchant(2649, "Fortitude", Item.ItemSlot.Wrist, new Stats(0, 0, 0, 12, 0, 0, 0)));
					_allEnchants.Add(new Enchant(1886, "Superior Stamina", Item.ItemSlot.Wrist, new Stats(0, 0, 0, 9, 0, 0, 0)));
					_allEnchants.Add(new Enchant(2648, "Major Defense", Item.ItemSlot.Wrist, new Stats(0, 0, 0, 0, 0, 12, 0)));
					_allEnchants.Add(new Enchant(1891, "Stats", Item.ItemSlot.Wrist, new Stats(0, 0, 4, 4, 0, 0, 0)));
					_allEnchants.Add(new Enchant(2564, "Superior Agility", Item.ItemSlot.Hands, new Stats(0, 0, 15, 0, 0, 0, 0)));
					_allEnchants.Add(new Enchant(2792, "Knothide Armor Kit", Item.ItemSlot.Hands, new Stats(0, 0, 0, 8, 0, 0, 0)));
					_allEnchants.Add(new Enchant(2793, "Vindicator's Armor Kit", Item.ItemSlot.Hands, new Stats(0, 0, 0, 0, 0, 8, 0)));
					_allEnchants.Add(new Enchant(3011, "Clefthide Leg Armor", Item.ItemSlot.Legs, new Stats(0, 0, 10, 30, 0, 0, 0)));
					_allEnchants.Add(new Enchant(3013, "Nethercleft Leg Armor", Item.ItemSlot.Legs, new Stats(0, 0, 12, 40, 0, 0, 0)));
					_allEnchants.Add(new Enchant(2793, "Vindicator's Armor Kit", Item.ItemSlot.Legs, new Stats(0, 0, 0, 0, 0, 8, 0)));
					_allEnchants.Add(new Enchant(2939, "Cat's Swiftness", Item.ItemSlot.Feet, new Stats(0, 0, 6, 0, 0, 0, 0)));
					_allEnchants.Add(new Enchant(2940, "Boar's Speed", Item.ItemSlot.Feet, new Stats(0, 0, 0, 9, 0, 0, 0)));
