...
namespace Rawr
{
	...
	public abstract class CalculationsBase
	{
		...
		/// subPointNameColors.Add("Mitigation", System.Windows.Media.Colors.Red);
		/// subPointNameColors.Add("Survival", System.Windows.Media.Colors.Blue);
		/// </summary>
		...
		/// <summary>
		/// A custom panel inheriting from ICalculationOptionsPanel which contains controls for
		/// setting CalculationOptions for the model. CalculationOptions are stored in the Character,
		/// and can be used by multiple models. See comments on ICalculationOptionsPanel for more details.
		/// </summary>
    ...
    CharacterCalculationsBase newCalculation, string name, bool equipped)
        ...
        public virtual void AccumulateItemStats(Stats stats, Character character, Item additionalItem)
        {
            ...
            if (additionalItem != null) stats.Accumulate(additionalItem.Stats);
