...
namespace Rawr
{
    ...
    public class Enchant
    {
        ...
        public static readonly string SavedFilePath = "EnchantCache.xml";
        ...
        /// <summary>
        /// A List containing all known enchants relevant to all models.
        /// </summary>
        ...
        {
            return AllEnchants.FirstOrDefault(delegate(Enchant enchant){
                return (enchant.Id == id) && (enchant.FitsInSlot(slot) ||
        ...
        {
            return new List<Enchant>(AllEnchants.Where(delegate(Enchant enchant) {
                    return (enchant.FitsInSlot(slot) || slot == Item.ItemSlot.None)
                        || enchant.Slot == Item.ItemSlot.None;
                }));
        }
        ...
        public static void Load(StreamReader reader)
        {
            ...
            finally { _allEnchants = _allEnchants ?? new List<Enchant>(); }
